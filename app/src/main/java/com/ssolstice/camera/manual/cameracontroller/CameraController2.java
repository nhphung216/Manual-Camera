...
public class CameraController2 extends CameraController {
    ...
    private boolean burst_for_noise_reduction; // chooses number of burst images and other settings for ManualCamera's noise reduction (NR) photo mode
    ...
    private class CameraSettings {
        ...
        private int getExifOrientation() {
            ...
            switch ((rotation + 360) % 360) {
                ...
                default:
                    ...
                    Logger.INSTANCE.e(TAG, "unexpected rotation: " + rotation);
                    break;
            }
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "rotation: " + rotation);
                Logger.INSTANCE.d(TAG, "exif_orientation: " + exif_orientation);
            }
        ...
        private void setupBuilder(CaptureRequest.Builder builder, boolean is_still) {
            ...
            /*if( MyDebug.LOG ) {
                ...
                for(int c=0;c<3;c++) {
                    Logger.INSTANCE.d(TAG, "color c = " + c);
                    for(int i=0;i<original_curve.getPointCount(c);i++) {
                        PointF point = original_curve.getPoint(c, i);
                        Logger.INSTANCE.d(TAG, "    i = " + i);
                        Logger.INSTANCE.d(TAG, "        in: " + point.x);
                        Logger.INSTANCE.d(TAG, "        out: " + point.y);
                    }
                }
            }*/
            /*if( Build.VERSION.SDK_INT >= Build.VERSION_CODES.M ) {
            ...
            if (MyDebug.LOG) {
                if (is_still) {
                    ...
                    Logger.INSTANCE.d(TAG, "nr_mode: " + (nr_mode == null ? "null" : nr_mode));
                    Integer edge_mode = builder.get(CaptureRequest.EDGE_MODE);
                    Logger.INSTANCE.d(TAG, "edge_mode: " + (edge_mode == null ? "null" : edge_mode));
                    Integer control_mode = builder.get(CaptureRequest.CONTROL_MODE);
                    Logger.INSTANCE.d(TAG, "control_mode: " + (control_mode == null ? "null" : control_mode));
                    Integer scene_mode = builder.get(CaptureRequest.CONTROL_SCENE_MODE);
                    Logger.INSTANCE.d(TAG, "scene_mode: " + (scene_mode == null ? "null" : scene_mode));
                    Integer cc_mode = builder.get(CaptureRequest.COLOR_CORRECTION_MODE);
                    Logger.INSTANCE.d(TAG, "cc_mode: " + (cc_mode == null ? "null" : cc_mode));
                    Integer cca_mode = builder.get(CaptureRequest.COLOR_CORRECTION_ABERRATION_MODE);
                    Logger.INSTANCE.d(TAG, "cca_mode: " + (cc_mode == null ? "null" : cca_mode));
                    /*if( Build.VERSION.SDK_INT >= Build.VERSION_CODES.N ) {
                        Integer raw_sensitivity_boost = builder.get(CaptureRequest.CONTROL_POST_RAW_SENSITIVITY_BOOST);
                        Logger.INSTANCE.d(TAG, "raw_sensitivity_boost: " + (raw_sensitivity_boost==null ? "null" : raw_sensitivity_boost));
                    }*/
                }
                //Integer ois_mode = builder.get(CaptureRequest.LENS_OPTICAL_STABILIZATION_MODE);
                //Logger.INSTANCE.d(TAG, "ois_mode: " + (ois_mode==null ? "null" : ois_mode));
            }
        }

        private boolean setSceneMode(CaptureRequest.Builder builder) {
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "setSceneMode");
                Logger.INSTANCE.d(TAG, "builder: " + builder);
                Logger.INSTANCE.d(TAG, "has_face_detect_mode: " + has_face_detect_mode);
            }
            ...
            Logger.INSTANCE.d(TAG, "current_scene_mode: " + current_scene_mode);
            if (has_face_detect_mode) {
                // face detection mode overrides scene mode
                Logger.INSTANCE.d(TAG, "setting scene mode for face detection");
                ...
                Logger.INSTANCE.d(TAG, "setting scene mode: " + scene_mode);
                int new_mode;
        ...
        private boolean setColorEffect(CaptureRequest.Builder builder) {
            ...
            /*else if( builder.get(CaptureRequest.CONTROL_EFFECT_MODE) == null && color_effect == CameraMetadata.CONTROL_EFFECT_MODE_OFF ) {
                ...
                Logger.INSTANCE.d(TAG, "setting color effect: " + color_effect);
        ...
        private boolean setWhiteBalance(CaptureRequest.Builder builder) {
            ...
            /*else if( builder.get(CaptureRequest.CONTROL_AWB_MODE) == null && white_balance == CameraMetadata.CONTROL_AWB_MODE_AUTO ) {
                ...
                Logger.INSTANCE.d(TAG, "setting white balance: " + white_balance);
            ...
            if (white_balance == CameraMetadata.CONTROL_AWB_MODE_OFF) {
                Logger.INSTANCE.d(TAG, "setting white balance temperature: " + white_balance_temperature);
                ...
                if (!has_default_color_correction) {
                    ...
                    Logger.INSTANCE.d(TAG, "default_color_correction: " + default_color_correction);
                }
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.d(TAG, "original color_correction_transform: " + builder.get(CaptureRequest.COLOR_CORRECTION_TRANSFORM));
                }
        ...
        private boolean setAntiBanding(CaptureRequest.Builder builder) {
            ...
            if (sessionType == SessionType.SESSIONTYPE_EXTENSION) {
                ...
                if (builder.get(CaptureRequest.CONTROL_AE_ANTIBANDING_MODE) == null || builder.get(CaptureRequest.CONTROL_AE_ANTIBANDING_MODE) != antibanding) {
                    Logger.INSTANCE.d(TAG, "setting antibanding: " + antibanding);
        ...
        private boolean setEdgeMode(CaptureRequest.Builder builder) {
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "setEdgeMode");
                Logger.INSTANCE.d(TAG, "has_default_edge_mode: " + has_default_edge_mode);
                Logger.INSTANCE.d(TAG, "default_edge_mode: " + default_edge_mode);
            }
            boolean changed = false;
            if (sessionType == SessionType.SESSIONTYPE_EXTENSION) {
                // don't set for extensions
                ...
                if (builder.get(CaptureRequest.EDGE_MODE) == null || builder.get(CaptureRequest.EDGE_MODE) != edge_mode) {
                    Logger.INSTANCE.d(TAG, "setting edge_mode: " + edge_mode);
                    builder.set(CaptureRequest.EDGE_MODE, edge_mode);
                    changed = true;
                } else {
                    Logger.INSTANCE.d(TAG, "edge_mode was already set: " + edge_mode);
                }
            } else if (is_samsung_s7) {
                Logger.INSTANCE.d(TAG, "set EDGE_MODE_OFF");
        ...
        private boolean setNoiseReductionMode(CaptureRequest.Builder builder) {
            ...
            if (sessionType == SessionType.SESSIONTYPE_EXTENSION) {
                ...
                if (!has_default_noise_reduction_mode) {
                    ...
                    Logger.INSTANCE.d(TAG, "default_noise_reduction_mode: " + default_noise_reduction_mode);
                }
                if (builder.get(CaptureRequest.NOISE_REDUCTION_MODE) == null || builder.get(CaptureRequest.NOISE_REDUCTION_MODE) != noise_reduction_mode) {
                    Logger.INSTANCE.d(TAG, "setting noise_reduction_mode: " + noise_reduction_mode);
                    builder.set(CaptureRequest.NOISE_REDUCTION_MODE, noise_reduction_mode);
                    changed = true;
                } else {
                    Logger.INSTANCE.d(TAG, "noise_reduction_mode was already set: " + noise_reduction_mode);
                }
            } else if (is_samsung_s7) {
                Logger.INSTANCE.d(TAG, "set NOISE_REDUCTION_MODE_OFF");
                // see https://sourceforge.net/p/opencamera/discussion/general/thread/48bd836b/ ,
                // https://stackoverflow.com/questions/36028273/android-camera-api-glossy-effect-on-galaxy-s7
        ...
        private boolean setAperture(CaptureRequest.Builder builder) {
            Logger.INSTANCE.d(TAG, "setAperture");
            if (sessionType == SessionType.SESSIONTYPE_EXTENSION) {
                // don't set for extensions
            } else if (has_aperture) {
                Logger.INSTANCE.d(TAG, "    aperture: " + aperture);
        ...
        private boolean setAEMode(CaptureRequest.Builder builder, boolean is_still) {
            Logger.INSTANCE.d(TAG, "setAEMode");
            ...
            if (has_iso) {
                ...
                if (!is_still) {
                    ...
                    Logger.INSTANCE.d(TAG, "actually using exposure_time of: " + actual_exposure_time);
                }
                ...
                if (ae_target_fps_range != null) {
                    Logger.INSTANCE.d(TAG, "set ae_target_fps_range: " + ae_target_fps_range);
        ...
        private boolean setExposureCompensation(CaptureRequest.Builder builder) {
            if (!has_ae_exposure_compensation)
                return false;
            if (has_iso) {
                Logger.INSTANCE.d(TAG, "don't set exposure compensation in manual iso mode");
                return false;
            }
            if (sessionType == SessionType.SESSIONTYPE_EXTENSION) {
                // don't set for extensions
            ...
            if (builder.get(CaptureRequest.CONTROL_AE_EXPOSURE_COMPENSATION) == null || ae_exposure_compensation != builder.get(CaptureRequest.CONTROL_AE_EXPOSURE_COMPENSATION)) {
                Logger.INSTANCE.d(TAG, "change exposure to " + ae_exposure_compensation);
        ...
        private void setStabilization(CaptureRequest.Builder builder) {
            Logger.INSTANCE.d(TAG, "setStabilization: " + video_stabilization);
            ...
            if (supports_optical_stabilization) {
                if (video_stabilization) {
                    ...
                    if (default_optical_stabilization == null) {
                        ...
                        Logger.INSTANCE.d(TAG, "default_optical_stabilization: " + default_optical_stabilization);
                    }
                    ...
                    if (builder.get(CaptureRequest.LENS_OPTICAL_STABILIZATION_MODE) != null && !builder.get(CaptureRequest.LENS_OPTICAL_STABILIZATION_MODE).equals(default_optical_stabilization)) {
                        Logger.INSTANCE.d(TAG, "set optical stabilization back to: " + default_optical_stabilization);
        ...
        private void setTonemapProfile(CaptureRequest.Builder builder) {
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "setTonemapProfile");
                Logger.INSTANCE.d(TAG, "tonemap_profile: " + tonemap_profile);
                Logger.INSTANCE.d(TAG, "log_profile_strength: " + log_profile_strength);
                Logger.INSTANCE.d(TAG, "gamma_profile: " + gamma_profile);
                Logger.INSTANCE.d(TAG, "default_tonemap_mode: " + default_tonemap_mode);
            }
            ...
            if (sessionType == SessionType.SESSIONTYPE_EXTENSION) {
                ...
                if (use_preset_curve && tonemap_profile == TonemapProfile.TONEMAPPROFILE_REC709 && Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    Logger.INSTANCE.d(TAG, "set TONEMAP_PRESET_CURVE_REC709");
                    builder.set(CaptureRequest.TONEMAP_MODE, CaptureRequest.TONEMAP_MODE_PRESET_CURVE);
                    ...
                    Logger.INSTANCE.d(TAG, "set TONEMAP_PRESET_CURVE_SRGB");
                    builder.set(CaptureRequest.TONEMAP_MODE, CaptureRequest.TONEMAP_MODE_PRESET_CURVE);
                    builder.set(CaptureRequest.TONEMAP_PRESET_CURVE, CaptureRequest.TONEMAP_PRESET_CURVE_SRGB);
                } else {
                    Logger.INSTANCE.d(TAG, "handle via TONEMAP_MODE_CONTRAST_CURVE / TONEMAP_CURVE");
                    float[] values = null;
                    switch (tonemap_profile) {
                        ...
                        case TONEMAPPROFILE_GAMMA: {
                            ...
                            //int n_values = 32;
                            Logger.INSTANCE.d(TAG, "n_values: " + n_values);
                        ...
                        if (MyDebug.LOG) {
                            ...
                            for (int i = 0; i < n_values; i++) {
                                ...
                                Logger.INSTANCE.d(TAG, "i = " + i);
                                //Logger.INSTANCE.d(TAG, "    in: " + (int)(in*255.0f+0.5f));
                                //Logger.INSTANCE.d(TAG, "    out: " + (int)(out*255.0f+0.5f));
                                Logger.INSTANCE.d(TAG, "    in: " + (in * 255.0f));
                                Logger.INSTANCE.d(TAG, "    out: " + (out * 255.0f));
                            }
                        }
                        break;
                        case TONEMAPPROFILE_JTVIDEO:
                            values = jtvideo_values;
                            Logger.INSTANCE.d(TAG, "setting JTVideo profile");
                            break;
                        case TONEMAPPROFILE_JTLOG:
                            values = jtlog_values;
                            Logger.INSTANCE.d(TAG, "setting JTLog profile");
                            break;
                        case TONEMAPPROFILE_JTLOG2:
                            values = jtlog2_values;
                            Logger.INSTANCE.d(TAG, "setting JTLog2 profile");
                            break;
                    }
                    ...
                    Logger.INSTANCE.d(TAG, "values: " + Arrays.toString(values));
                    if (values != null) {
                        ...
                        Logger.INSTANCE.e(TAG, "unknown log type: " + tonemap_profile);
                    }
                }
    ...
    public static float[] convertTemperatureToRggb(int temperature_kelvin) {
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "red: " + red);
            Logger.INSTANCE.d(TAG, "green: " + green);
            Logger.INSTANCE.d(TAG, "blue: " + blue);
        }
        ...
        blue = RGBtoGain(blue);
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "red gain: " + red);
            Logger.INSTANCE.d(TAG, "green gain: " + green);
            Logger.INSTANCE.d(TAG, "blue gain: " + blue);
        }
    ...
    private void postNextSlowBurst() {
        Logger.INSTANCE.d(TAG, "postNextSlowBurst");
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Logger.INSTANCE.d(TAG, "take picture after delay for next slow burst");
                if (camera != null && hasCaptureSession()) { // make sure camera wasn't released in the meantime
                    ...
                    if (picture_cb.imageQueueWouldBlock(imageReaderRaw != null ? 1 : 0, 1)) {
                        if (MyDebug.LOG) {
                            Logger.INSTANCE.d(TAG, "...but wait for next bracket, as image queue would block");
                        }
                        ...
                        try {
                            ...
                            Logger.INSTANCE.e(TAG, "failed to take next focus bracket");
                            Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                            Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                            jpeg_todo = false;
                            raw_todo = false;
                            picture_cb = null;
    ...
    private class OnImageAvailableListener implements ImageReader.OnImageAvailableListener {
        ...
        public void onImageAvailable(ImageReader reader) {
            Logger.INSTANCE.d(TAG, "new still image available");
            if (picture_cb == null || !jpeg_todo) {
                ...
                Logger.INSTANCE.e(TAG, "no picture callback available");
            ...
            if (skip_next_image) {
                Logger.INSTANCE.d(TAG, "skipping image");
            ...
            if (image == null) {
                ...
                Logger.INSTANCE.e(TAG, "onImageAvailable: image is null");
                return;
            }
            Logger.INSTANCE.d(TAG, "image timestamp: " + image.getTimestamp());
            ByteBuffer buffer = image.getPlanes()[0].getBuffer();
            byte[] bytes = new byte[buffer.remaining()];
            Logger.INSTANCE.d(TAG, "read " + bytes.length + " bytes");
            buffer.get(bytes);
            image.close();
            ...
            synchronized (background_camera_lock) {
                n_burst_taken++;
                if (MyDebug.LOG) {
                    Logger.INSTANCE.d(TAG, "n_burst_taken is now: " + n_burst_taken);
                    Logger.INSTANCE.d(TAG, "n_burst: " + n_burst);
                    Logger.INSTANCE.d(TAG, "burst_single_request: " + burst_single_request);
                }
                if (burst_single_request) {
                    pending_burst_images.add(bytes);
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.d(TAG, "pending_burst_images size is now: " + pending_burst_images.size());
                    }
            ...
            synchronized (background_camera_lock) {
                if (single_burst_complete_images != null) {
                    ...
                    n_burst--;
                    Logger.INSTANCE.d(TAG, "n_burst is now " + n_burst);
                    if (burst_type == BurstType.BURSTTYPE_CONTINUOUS && !continuous_burst_requested_last_capture) {
                        ...
                        Logger.INSTANCE.d(TAG, "continuous burst mode still in progress");
                        call_takePhotoPartial = true;
                    } else if (n_burst == 0) {
                        call_takePhotoCompleted = true;
                    } else {
            ...
            Logger.INSTANCE.d(TAG, "done onImageAvailable");
        }
        ...
        private void takePhotoPartial() {
            Logger.INSTANCE.d(TAG, "takePhotoPartial");
            ...
            synchronized (background_camera_lock) {
                if (slow_burst_capture_requests != null) {
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.d(TAG, "need to execute the next capture");
                        Logger.INSTANCE.d(TAG, "time since start: " + (System.currentTimeMillis() - slow_burst_start_ms));
                    }
                    if (burst_type != BurstType.BURSTTYPE_FOCUS) {
                        /*try {
                            if( camera != null && hasCaptureSession() ) { // make sure camera wasn't released in the meantime
                            ...
                            if( MyDebug.LOG ) {
                                Logger.INSTANCE.e(TAG, "failed to take next burst");
                                Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                            }
                            e.printStackTrace();
                        ...
                        if (previewBuilder != null) { // make sure camera wasn't released in the meantime
                            try {
                                ...
                                if (MyDebug.LOG) {
                                    Logger.INSTANCE.d(TAG, "prepare preview for next exposure: " + exposure_time);
                                }
                                ...
                                if (MyDebug.LOG) {
                                    Logger.INSTANCE.e(TAG, "failed to take set exposure for next expo bracketing burst");
                                    Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                                    Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                                }
                                e.printStackTrace();
                        ...
                        Logger.INSTANCE.d(TAG, "focus bracketing");

                        if (!focus_bracketing_in_progress) {
                            Logger.INSTANCE.d(TAG, "focus bracketing was cancelled");
                            ...
                            if (MyDebug.LOG) {
                                Logger.INSTANCE.d(TAG, "slow_burst_capture_requests size was: " + slow_burst_capture_requests.size());
                                Logger.INSTANCE.d(TAG, "n_burst size was: " + n_burst);
                                Logger.INSTANCE.d(TAG, "n_burst_taken: " + n_burst_taken);
                            }
                            ...
                            if (MyDebug.LOG) {
                                Logger.INSTANCE.d(TAG, "size is now: " + slow_burst_capture_requests.size());
                                Logger.INSTANCE.d(TAG, "n_burst is now: " + n_burst);
                                Logger.INSTANCE.d(TAG, "n_burst_raw is now: " + n_burst_raw);
                            }
                        ...
                        try {
                            ...
                            if (MyDebug.LOG) {
                                Logger.INSTANCE.d(TAG, "prepare preview for next focus_distance: " + focus_distance);
                            }
                            ...
                            if (MyDebug.LOG) {
                                Logger.INSTANCE.e(TAG, "failed to take set focus distance for next focus bracketing burst");
                                Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                            }
                            e.printStackTrace();
        ...
        private void takePhotoCompleted() {
            Logger.INSTANCE.d(TAG, "takePhotoCompleted");
    ...
    private class OnRawImageAvailableListener implements ImageReader.OnImageAvailableListener {
        ...
        void setCaptureResult(CaptureResult capture_result) {
            Logger.INSTANCE.d(TAG, "setCaptureResult()");
            synchronized (background_camera_lock) {
                ...
                if (images.size() > 0) {
                    Logger.INSTANCE.d(TAG, "can now process the image");
                    ...
                    activity.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Logger.INSTANCE.d(TAG, "setCaptureResult UI thread call processImage()");
        ...
        private void processImage() {
            Logger.INSTANCE.d(TAG, "processImage()");
            ...
            synchronized (background_camera_lock) {
                if (capture_results.size() == 0) {
                    Logger.INSTANCE.d(TAG, "don't yet have still_capture_result");
                    return;
                }
                if (images.size() == 0) {
                    Logger.INSTANCE.d(TAG, "don't have image?!");
                    return;
                }
                capture_result = capture_results.remove();
                image = images.remove();
                if (MyDebug.LOG) {
                    Logger.INSTANCE.d(TAG, "now have all info to process raw image");
                    Logger.INSTANCE.d(TAG, "image timestamp: " + image.getTimestamp());
                }
                ...
                if (n_burst_total == 1 && burst_type != BurstType.BURSTTYPE_CONTINUOUS) {
                    ...
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.d(TAG, "pending_burst_images_raw size is now: " + pending_burst_images_raw.size());
                    }
                    if (pending_burst_images_raw.size() >= n_burst_raw) { // shouldn't ever be greater, but just in case
                        Logger.INSTANCE.d(TAG, "all raw burst images available");
                        if (pending_burst_images_raw.size() > n_burst_raw) {
                            Logger.INSTANCE.e(TAG, "pending_burst_images_raw size " + pending_burst_images_raw.size() + " is greater than n_burst_raw " + n_burst_raw);
                        }
                        ...
                        Logger.INSTANCE.d(TAG, "number of raw burst images is now: " + pending_burst_images_raw.size());
                    }
                }
                // case for burst_single_request==false handled below
            }
            ...
            Logger.INSTANCE.d(TAG, "done processImage");
        }

        @Override
        public void onImageAvailable(ImageReader reader) {
            Logger.INSTANCE.d(TAG, "new still raw image available");
            ...
            synchronized (background_camera_lock) {
                ...
                Image image = reader.acquireNextImage();
                if (image == null) {
                    Logger.INSTANCE.e(TAG, "RAW onImageAvailable: image is null");
                    return;
                }
                images.add(image);
            }
            processImage();
            Logger.INSTANCE.d(TAG, "done (RAW) onImageAvailable");
        }
    }
    ...
    private void onError(@NonNull CameraDevice cam) {
        ...
        this.camera = null;
        Logger.INSTANCE.d(TAG, "onError: camera is now set to null");
        cam.close();
        Logger.INSTANCE.d(TAG, "onError: camera is now closed");
        ...
        if (camera_already_opened) {
            ...
            Logger.INSTANCE.e(TAG, "error occurred after camera was opened");
            // important to run on UI thread to avoid synchronisation issues in the Preview
            final Activity activity = (Activity) context;
            activity.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Logger.INSTANCE.d(TAG, "onError: call camera_error_cb.onError() on UI thread");
    ...
    public CameraController2(Context context, int cameraId, String cameraIdSPhysical, Map<String, CameraFeaturesCache> camera_features_caches, final ErrorCallback preview_error_cb, final ErrorCallback camera_error_cb) throws CameraControllerException {
        super(cameraId);
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "create new CameraController2: " + cameraId + " / " + cameraIdSPhysical);
            Logger.INSTANCE.d(TAG, "this: " + this);
        }
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "is_samsung: " + is_samsung);
            Logger.INSTANCE.d(TAG, "is_samsung_s7: " + is_samsung_s7);
            Logger.INSTANCE.d(TAG, "is_samsung_galaxy_s: " + is_samsung_galaxy_s);
            Logger.INSTANCE.d(TAG, "is_samsung_galaxy_f: " + is_samsung_galaxy_f);
        }
        ...
        class MyStateCallback extends CameraDevice.StateCallback {
            ...
            public void onOpened(@NonNull CameraDevice cam) {
                Logger.INSTANCE.d(TAG, "camera opened, first_callback? " + first_callback);
                ...
                if (first_callback) {
                    ...
                    try {
                        ...
                        Logger.INSTANCE.d(TAG, "try to get camera characteristics");
                        characteristics = manager.getCameraCharacteristics(cameraIdSPhysical != null ? cameraIdSPhysical : cameraIdS);
                        Logger.INSTANCE.d(TAG, "successfully obtained camera characteristics");
                        ...
                        if (MyDebug.LOG) {
                            Logger.INSTANCE.e(TAG, "failed to get camera characteristics");
                            Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                            Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                        }
                        e.printStackTrace();
                    ...
                    Logger.INSTANCE.d(TAG, "about to synchronize to say callback done");
                    synchronized (open_camera_lock) {
                        callback_done = true;
                        Logger.INSTANCE.d(TAG, "callback done, about to notify");
                        open_camera_lock.notifyAll();
                        Logger.INSTANCE.d(TAG, "callback done, notify done");
                    }
                }
            }
            ...
            public void onClosed(@NonNull CameraDevice cam) {
                Logger.INSTANCE.d(TAG, "camera closed, first_callback? " + first_callback);
            ...
            public void onDisconnected(@NonNull CameraDevice cam) {
                Logger.INSTANCE.d(TAG, "camera disconnected, first_callback? " + first_callback);
                if (first_callback) {
                    first_callback = false;
                    // must call close() if disconnected before camera was opened
                    // need to set the camera to null first, as closing the camera may take some time, and we don't want any other operations to continue (if called from main thread)
                    CameraController2.this.camera = null;
                    Logger.INSTANCE.d(TAG, "onDisconnected: camera is now set to null");
                    cam.close();
                    Logger.INSTANCE.d(TAG, "onDisconnected: camera is now closed");
                    Logger.INSTANCE.d(TAG, "about to synchronize to say callback done");
                    synchronized (open_camera_lock) {
                        callback_done = true;
                        Logger.INSTANCE.d(TAG, "callback done, about to notify");
            ...
            public void onError(@NonNull CameraDevice cam, int error) {
                // n.b., as this is potentially serious error, we always log even if MyDebug.LOG is false
                Logger.INSTANCE.e(TAG, "camera error: " + error);
                if (first_callback) {
                    first_callback = false;
                }
        ...
        try {
            Logger.INSTANCE.d(TAG, "get camera id list");
            this.cameraIdS = manager.getCameraIdList()[cameraId];
            Logger.INSTANCE.d(TAG, "about to open camera: " + cameraIdS);
            manager.openCamera(cameraIdS, myStateCallback, handler);
            Logger.INSTANCE.d(TAG, "open camera request complete");
        } catch (CameraAccessException e) {
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "failed to open camera: CameraAccessException");
                Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
            }
            e.printStackTrace();
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "failed to open camera: UnsupportedOperationException");
                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
            }
            e.printStackTrace();
            throw new CameraControllerException();
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "failed to open camera: SecurityException");
                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
            }
            e.printStackTrace();
            throw new CameraControllerException();
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "failed to open camera: IllegalArgumentException");
                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
            }
            e.printStackTrace();
            throw new CameraControllerException();
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "failed to open camera: ArrayIndexOutOfBoundsException");
                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
            }
            e.printStackTrace();
            throw new CameraControllerException();
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                Logger.INSTANCE.d(TAG, "check if camera has opened in reasonable time: " + this);
                synchronized (open_camera_lock) {
                    if (!myStateCallback.callback_done) {
                        // n.b., as this is potentially serious error, we always log even if MyDebug.LOG is false
                        Logger.INSTANCE.e(TAG, "timeout waiting for camera callback");
        ...
        Logger.INSTANCE.d(TAG, "wait until camera opened...");
        ...
        synchronized (open_camera_lock) {
            while (!myStateCallback.callback_done) {
                try {
                    ...
                    Logger.INSTANCE.d(TAG, "interrupted while waiting until camera opened");
                    e.printStackTrace();
                }
            }
        }
        if (camera == null) {
            // n.b., as this is potentially serious error, we always log even if MyDebug.LOG is false
            Logger.INSTANCE.e(TAG, "camera failed to open");
            throw new CameraControllerException();
        }
        Logger.INSTANCE.d(TAG, "camera now opened: " + camera);
    ...
    private void closeCaptureSession() {
        synchronized (background_camera_lock) {
            if (captureSession != null) {
                Logger.INSTANCE.d(TAG, "close capture session");
                captureSession.close();
                captureSession = null;
            }
            if (extensionSession != null) {
                Logger.INSTANCE.d(TAG, "close extension session");
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                    try {
    ...
    @Override
    public void release() {
        Logger.INSTANCE.d(TAG, "release: " + this);
        closeCaptureSession();
        previewBuilder = null;
    ...
    private float[] enforceMinTonemapCurvePoints(float[] in_values) {
        ...
        Logger.INSTANCE.d(TAG, "min_points_c: " + min_points_c);
        if (in_values.length >= 2 * min_points_c) {
            Logger.INSTANCE.d(TAG, "already enough points");
        ...
        if (points.size() < 2) {
            Logger.INSTANCE.e(TAG, "less than 2 points?!");
            return in_values;
        }
        ...
        while (points.size() < min_points_c) {
            ...
            /*if( MyDebug.LOG )
                Logger.INSTANCE.d(TAG, "largest indx " + largest_indx + " dist: " + largest_dist);*/
            ...
            /*if( MyDebug.LOG )
                Logger.INSTANCE.d(TAG, "    insert: " + mid_x + " , " + mid_y);*/
        ...
        for (int i = 0; i < points.size(); i++) {
            ...
            /*if( MyDebug.LOG )
                Logger.INSTANCE.d(TAG, "out point[" + i + "]: " + point.first + " , " + point.second);*/
        }
        return out_values;
    }

    private void closePictureImageReader() {
        Logger.INSTANCE.d(TAG, "closePictureImageReader()");
        if (imageReader != null) {
            imageReader.close();
            imageReader = null;
    ...
    private List<String> convertFocusModesToValues(int[] supported_focus_modes_arr) {
        if (supported_focus_modes_arr.length == 0) {
            Logger.INSTANCE.d(TAG, "no supported focus modes");
            return null;
        }
        ...
        if (supported_focus_modes.contains(CaptureRequest.CONTROL_AF_MODE_OFF)) {
            ...
            if (minimum_focus_distance > 0.0f) {
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.d(TAG, " supports focus_mode_manual2");
                }
            }
        }
    ...
    public CameraFeatures getCameraFeatures() throws CameraControllerException {
        ...
        if (MyDebug.LOG) {
            ...
            switch (hardware_level) {
                case CameraCharacteristics.INFO_SUPPORTED_HARDWARE_LEVEL_LEGACY:
                    Logger.INSTANCE.d(TAG, "Hardware Level: LEGACY");
                    break;
                case CameraCharacteristics.INFO_SUPPORTED_HARDWARE_LEVEL_LIMITED:
                    Logger.INSTANCE.d(TAG, "Hardware Level: LIMITED");
                    break;
                case CameraCharacteristics.INFO_SUPPORTED_HARDWARE_LEVEL_FULL:
                    Logger.INSTANCE.d(TAG, "Hardware Level: FULL");
                    break;
                case CameraCharacteristics.INFO_SUPPORTED_HARDWARE_LEVEL_3:
                    Logger.INSTANCE.d(TAG, "Hardware Level: Level 3");
                    break;
                default:
                    Logger.INSTANCE.e(TAG, "Unknown Hardware Level: " + hardware_level);
                    break;
            }
        }
        ...
        if (cameraIdSPhysical != null) {
            ...
            if (zoom_ratio_range != null) {
                ...
                Logger.INSTANCE.d(TAG, "zoom_ratio_range not supported");
            }
        } else {
            min_zoom = 1.0f;
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "min_zoom: " + min_zoom);
            Logger.INSTANCE.d(TAG, "max_zoom: " + max_zoom);
        }
        if (camera_features.is_zoom_supported) {
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "zoom_ratios: " + zoom_ratios);
            }
        } else {
        ...
        for (int face_mode : face_modes) {
            Logger.INSTANCE.d(TAG, "face detection mode: " + face_mode);
            ...
            if (face_mode == CameraCharacteristics.STATISTICS_FACE_DETECT_MODE_SIMPLE) {
                ...
                Logger.INSTANCE.d(TAG, "supports simple face detection mode");
            } else if (face_mode == CameraCharacteristics.STATISTICS_FACE_DETECT_MODE_FULL) {
                camera_features.supports_face_detection = true;
                supports_face_detect_mode_full = true;
                Logger.INSTANCE.d(TAG, "supports full face detection mode");
            }
        }
        if (camera_features.supports_face_detection) {
            ...
            if (face_count <= 0) {
                Logger.INSTANCE.d(TAG, "can't support face detection, as zero max face count");
                camera_features.supports_face_detection = false;
                supports_face_detect_mode_simple = false;
                supports_face_detect_mode_full = false;
            }
        ...
        if (camera_features.supports_face_detection) {
            ...
            Logger.INSTANCE.d(TAG, "has_face_priority: " + has_face_priority);
            if (!has_face_priority) {
                Logger.INSTANCE.d(TAG, "can't support face detection, as no CONTROL_SCENE_MODE_FACE_PRIORITY");
                camera_features.supports_face_detection = false;
                supports_face_detect_mode_simple = false;
                supports_face_detect_mode_full = false;
            }
        ...
        if (cameraIdSPhysical != null) {
            ...
            try {
                ...
                Logger.INSTANCE.e(TAG, "failed to get logical_characteristics for: " + cameraIdS);
                e.printStackTrace();
                throw new CameraControllerException();
            }
            Logger.INSTANCE.d(TAG, "successfully obtained logical camera characteristics");
        } else {
        ...
        for (int capability : capabilities) {
            ...
            /*else if( capability == CameraCharacteristics.REQUEST_AVAILABLE_CAPABILITIES_BURST_CAPTURE ) {
                ...
                Logger.INSTANCE.d(TAG, "camera supports ultra high resolution");
            }
        }
        ...
        for (int capability : logical_capabilities) {
            ...
            if (capability == CameraCharacteristics.REQUEST_AVAILABLE_CAPABILITIES_LOGICAL_MULTI_CAMERA && Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
                ...
                Logger.INSTANCE.d(TAG, "camera is a logical multi-camera");
        ...
        // support fast burst - and which ManualCamera never allowed with Camera2 before 1.45).
        // Also may affect Samsung Galaxy A8(2018).
        ...
        if (MyDebug.LOG) {
            //Logger.INSTANCE.d(TAG, "capabilities_manual_sensor?: " + capabilities_manual_sensor);
            Logger.INSTANCE.d(TAG, "capabilities_manual_post_processing?: " + capabilities_manual_post_processing);
            Logger.INSTANCE.d(TAG, "capabilities_raw?: " + capabilities_raw);
            Logger.INSTANCE.d(TAG, "supports_burst?: " + camera_features.supports_burst);
            Logger.INSTANCE.d(TAG, "capabilities_high_speed_video?: " + capabilities_high_speed_video);
            Logger.INSTANCE.d(TAG, "capabilities_10bit?: " + capabilities_10bit);
        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.UPSIDE_DOWN_CAKE && capabilities_10bit) {
            ...
            if (jpeg_r_camera_picture_sizes != null) {
                Logger.INSTANCE.d(TAG, "JPEG_R sizes: " + Arrays.toString(jpeg_r_camera_picture_sizes));
                ...
                if (!sizeSubset(camera_picture_sizes, jpeg_r_camera_picture_sizes)) {
                    Logger.INSTANCE.d(TAG, "don't support JPEG_R: some picture sizes not supported");
                    camera_features.supports_jpeg_r = false;
                }
                ...
                if (camera_features.supports_jpeg_r) {
                    ...
                    if (profiles == null) {
                        Logger.INSTANCE.d(TAG, "don't support JPEG_R: no DynamicRangeProfiles");
                        camera_features.supports_jpeg_r = false;
                    } else if (!profiles.getSupportedProfiles().contains(DynamicRangeProfiles.HLG10)) {
                        Logger.INSTANCE.d(TAG, "don't support JPEG_R: no HLG10");
                        camera_features.supports_jpeg_r = false;
                    }
                }
            } else {
                Logger.INSTANCE.d(TAG, "JPEG_R not supported");
            }

            Logger.INSTANCE.d(TAG, "time for jpeg_r testing: " + (System.currentTimeMillis() - debug_time));
        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (camera_picture_sizes_hires != null) {
                for (android.util.Size camera_size : camera_picture_sizes_hires) {
                    Logger.INSTANCE.d(TAG, "high resolution picture size: " + camera_size.getWidth() + " x " + camera_size.getHeight());
                    ...
                    if (!found) {
                        Logger.INSTANCE.d(TAG, "high resolution [non-burst] picture size: " + camera_size.getWidth() + " x " + camera_size.getHeight());
                ...
                if (camera_features.supports_jpeg_r && Build.VERSION.SDK_INT >= Build.VERSION_CODES.UPSIDE_DOWN_CAKE) {
                    ...
                    if (!sizeSubset(camera_picture_sizes_hires, camera_picture_sizes_hires_jpeg_r)) {
                        Logger.INSTANCE.d(TAG, "don't support JPEG_R: some high resolution (non-burst) picture sizes not supported");
                        camera_features.supports_jpeg_r = false;
                    }
                }
            }
        ...
        if (camera_picture_sizes == null) {
            ...
            Logger.INSTANCE.e(TAG, "no picture sizes returned by getOutputSizes");
            throw new CameraControllerException();
        } else {
            for (android.util.Size camera_size : camera_picture_sizes) {
                Logger.INSTANCE.d(TAG, "picture size: " + camera_size.getWidth() + " x " + camera_size.getHeight());
        ...
        if (capabilities_raw) {
            ...
            if (raw_camera_picture_sizes == null) {
                Logger.INSTANCE.d(TAG, "RAW not supported, failed to get RAW_SENSOR sizes");
                ...
                if (raw_size == null) {
                    Logger.INSTANCE.d(TAG, "RAW not supported, failed to find a raw size");
                    want_raw = false; // just in case it got set to true somehow
                } else {
                    Logger.INSTANCE.d(TAG, "raw supported, raw size: " + raw_size.getWidth() + " x " + raw_size.getHeight());
                    camera_features.supports_raw = true;
                }
            }
        } else {
            Logger.INSTANCE.d(TAG, "RAW capability not supported");
            want_raw = false; // just in case it got set to true somehow
        }
        ...
        if (camera_video_sizes == null) {
            ...
            Logger.INSTANCE.e(TAG, "no video sizes returned by getOutputSizes");
            throw new CameraControllerException();
        } else {
            for (android.util.Size camera_size : camera_video_sizes) {
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.d(TAG, "normal video size: " + normal_video_size);
                }
            }
        }
        ...
        if (capabilities_high_speed_video && cameraIdSPhysical == null) {
            ...
            for (Range<Integer> r : configs.getHighSpeedVideoFpsRanges()) {
                ...
                if (r.getLower().intValue() != r.getUpper().intValue()) {
                    Logger.INSTANCE.d(TAG, "skip high speed video fps range: " + r);
                    continue;
                }
            ...
            for (android.util.Size camera_size : camera_video_sizes_high_speed) {
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.d(TAG, "high speed video size: " + hs_video_size);
                }
        ...
        Activity activity = (Activity) context;
        {
            ...
            // would be good to not assume ManualCamera runs in landscape mode (if we ever ran in portrait mode,
        ...
        if (camera_preview_sizes == null) {
            ...
            Logger.INSTANCE.e(TAG, "no preview sizes returned by getOutputSizes");
            throw new CameraControllerException();
        } else {
        ...
        if (extension_characteristics == null) {
            ...
            Logger.INSTANCE.d(TAG, "read vendor extensions info from cache");
            ...
            if (camera_features.supported_extensions != null) {
                for (int extension : camera_features.supported_extensions) {
                    Logger.INSTANCE.d(TAG, "vendor extension: " + extension);
                    ...
                    if (has_picture_resolution && has_preview_resolution) {
                        ...
                        Logger.INSTANCE.e(TAG, "cached extension not actually supported?!: " + extension);
            ...
            Logger.INSTANCE.d(TAG, "done read vendor extensions info from cache");
        } else if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            Logger.INSTANCE.d(TAG, "check for vendor extensions");
            ...
            try {
                ...
                Logger.INSTANCE.e(TAG, "exception from getSupportedExtensions");
            }
            if (extensions != null) {
                ...
                for (int extension : extensions) {
                    ...
                    try {
                        ...
                        Logger.INSTANCE.d(TAG, "    extension_picture_sizes: " + extension_picture_sizes);
                        boolean has_picture_resolution = updatePictureSizesForExtension(camera_features.picture_sizes, extension_picture_sizes, extension);
                        ...
                        Logger.INSTANCE.d(TAG, "    extension_preview_sizes: " + extension_preview_sizes);
                        boolean has_preview_resolution = updatePreviewSizesForExtension(camera_features.preview_sizes, extension_preview_sizes, extension);

                        if (has_picture_resolution && has_preview_resolution) {
                            Logger.INSTANCE.d(TAG, "    extension is supported: " + extension);
                            ...
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                                ...
                                for (CaptureRequest.Key<?> key : extension_supported_request_keys) {
                                    Logger.INSTANCE.d(TAG, "    supported capture request key: " + key.getName());
                        ...
                        Logger.INSTANCE.e(TAG, "exception trying to query extension: " + extension);
                        camera_features.supported_extensions.remove((Integer) extension);
                        camera_features.supported_extensions_zoom.remove((Integer) extension);
            ...
            Logger.INSTANCE.d(TAG, "done check for vendor extensions");
        }
        ...
        if (minimum_focus_distance_f != null) {
            ...
            Logger.INSTANCE.d(TAG, "minimum_focus_distance: " + camera_features.minimum_focus_distance);
        } else {
        ...
        if (camera_features.supported_focus_values != null) {
            ...
            Logger.INSTANCE.d(TAG, "initial_focus_mode: " + initial_focus_mode);
        } else {
            ...
            if (iso_range != null) {
                ...
                if (exposure_time_range != null) {
                    ...
                    if ((is_samsung_galaxy_s || is_samsung_galaxy_f) && Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                        ...
                        Logger.INSTANCE.d(TAG, "boost max_exposure_time, was: " + max_exposure_time);
        ...
        if (capabilities_manual_post_processing) {
            ...
            if (tonemap_max_curve_points != null) {
                Logger.INSTANCE.d(TAG, "tonemap_max_curve_points: " + tonemap_max_curve_points);
                ...
                if (tonemap_modes == null) {
                    ...
                    Logger.INSTANCE.d(TAG, "tonemap_modes is null");
                } else {
                    ...
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.d(TAG, "supports_tonemap_preset_curve: " + supports_tonemap_preset_curve);
                        Logger.INSTANCE.d(TAG, "supports_tonemap_contrast_curve: " + supports_tonemap_contrast_curve);
                    }
                ...
                Logger.INSTANCE.d(TAG, "tonemap_max_curve_points is null");
            }
        }
        Logger.INSTANCE.d(TAG, "supports_tonemap_curve?: " + camera_features.supports_tonemap_curve);
        ...
        Logger.INSTANCE.d(TAG, "apertures: " + Arrays.toString(apertures));
        ...
        if (capabilities_logical_multi_camera && Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            ...
            Logger.INSTANCE.d(TAG, "physical_camera_ids: " + camera_features.physical_camera_ids);
    ...
    private boolean updatePictureSizesForExtension(List<CameraController.Size> picture_sizes, List<android.util.Size> extension_picture_sizes, int extension) {
        ...
        for (CameraController.Size size : picture_sizes) {
            if (extension_picture_sizes.contains(new android.util.Size(size.width, size.height))) {
                if (MyDebug.LOG) {
                    Logger.INSTANCE.d(TAG, "    picture size supports extension: " + size.width + " , " + size.height);
                }
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.d(TAG, "    picture size does NOT support extension: " + size.width + " , " + size.height);
                }
            }
        }
    ...
    private boolean updatePreviewSizesForExtension(List<CameraController.Size> preview_sizes, List<android.util.Size> extension_preview_sizes, int extension) {
        ...
        for (CameraController.Size size : preview_sizes) {
            if (extension_preview_sizes.contains(new android.util.Size(size.width, size.height))) {
                if (MyDebug.LOG) {
                    Logger.INSTANCE.d(TAG, "    preview size supports extension: " + size.width + " , " + size.height);
                }
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.d(TAG, "    preview size does NOT support extension: " + size.width + " , " + size.height);
                }
            }
        }
    ...
    private String convertSceneMode(int value2) {
        ...
        /*case CameraMetadata.CONTROL_SCENE_MODE_HIGH_SPEED_VIDEO:
            ...
            case CameraMetadata.CONTROL_SCENE_MODE_THEATRE:
                ...
                break;
            default:
                Logger.INSTANCE.d(TAG, "unknown scene mode: " + value2);
                value = null;
                break;
        }
        return value;
    ...
    public SupportedValues setSceneMode(String value) {
        Logger.INSTANCE.d(TAG, "setSceneMode: " + value);
        ...
        if (supported_values != null) {
            ...
            switch (supported_values.selected_value) {
                ...
                case "theatre":
                    ...
                    break;
                default:
                    Logger.INSTANCE.d(TAG, "unknown selected_value: " + supported_values.selected_value);
                    break;
            }
            ...
            if (camera_settings.setSceneMode(previewBuilder)) {
                try {
                    ...
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.e(TAG, "failed to set scene mode");
                        Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                        Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                    }
                    e.printStackTrace();
    ...
    private String convertColorEffect(int value2) {
        ...
        switch (value2) {
            ...
            case CameraMetadata.CONTROL_EFFECT_MODE_WHITEBOARD:
                ...
                break;
            default:
                Logger.INSTANCE.d(TAG, "unknown effect mode: " + value2);
                value = null;
                break;
        }
        return value;
    ...
    public SupportedValues setColorEffect(String value) {
        Logger.INSTANCE.d(TAG, "setColorEffect: " + value);
        // we convert to/from strings to be compatible with original Android Camera API
        ...
        if (supported_values != null) {
            ...
            if (camera_settings.setColorEffect(previewBuilder)) {
                try {
                    ...
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.e(TAG, "failed to set color effect");
                        Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                        Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                    }
                    e.printStackTrace();
    ...
    private String convertWhiteBalance(int value2) {
        ...
        switch (value2) {
            ...
            case CameraMetadata.CONTROL_AWB_MODE_OFF:
                ...
                break;
            default:
                Logger.INSTANCE.d(TAG, "unknown white balance: " + value2);
                value = null;
                break;
        }
        return value;
        ...
        if (supported_values != null) {
            ...
            if (camera_settings.setWhiteBalance(previewBuilder)) {
                try {
                    ...
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.e(TAG, "failed to set white balance");
                        Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                        Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                    }
                    e.printStackTrace();
    ...
    public boolean setWhiteBalanceTemperature(int temperature) {
        Logger.INSTANCE.d(TAG, "setWhiteBalanceTemperature: " + temperature);
        if (camera_settings.white_balance == temperature) {
            Logger.INSTANCE.d(TAG, "already set");
            return false;
        }
        try {
            temperature = Math.max(temperature, min_white_balance_temperature_c);
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "failed to set white balance temperature");
                Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
            }
            e.printStackTrace();
    ...
    private String convertAntiBanding(int value2) {
        ...
        switch (value2) {
            ...
            case CameraMetadata.CONTROL_AE_ANTIBANDING_MODE_OFF:
                ...
                break;
            default:
                Logger.INSTANCE.d(TAG, "unknown antibanding: " + value2);
                value = null;
                break;
        }
        return value;
    ...
    public SupportedValues setAntiBanding(String value) {
        Logger.INSTANCE.d(TAG, "setAntiBanding: " + value);
        // we convert to/from strings to be compatible with original Android Camera API
            ...
            if (supported_values.selected_value.equals(value)) {
                ...
                if (camera_settings.setAntiBanding(previewBuilder)) {
                    try {
                        ...
                        if (MyDebug.LOG) {
                            Logger.INSTANCE.e(TAG, "failed to set antibanding");
                            Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                            Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                        }
                        e.printStackTrace();
    ...
    private String convertEdgeMode(int value2) {
        ...
        switch (value2) {
            ...
            case CameraMetadata.EDGE_MODE_ZERO_SHUTTER_LAG:
                ...
                break;
            default:
                Logger.INSTANCE.d(TAG, "unknown edge_mode: " + value2);
                value = null;
                break;
        }
        return value;
    ...
    public SupportedValues setEdgeMode(String value) {
        Logger.INSTANCE.d(TAG, "setEdgeMode: " + value);
                ...
                if (camera_settings.has_edge_mode != has_edge_mode || camera_settings.edge_mode != selected_value2) {
                    ...
                    if (camera_settings.setEdgeMode(previewBuilder)) {
                        try {
                            ...
                            if (MyDebug.LOG) {
                                Logger.INSTANCE.e(TAG, "failed to set edge_mode");
                                Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                            }
                            e.printStackTrace();
    ...
    private String convertNoiseReductionMode(int value2) {
        ...
        switch (value2) {
            ...
            case CameraMetadata.NOISE_REDUCTION_MODE_ZERO_SHUTTER_LAG:
                ...
                break;
            default:
                Logger.INSTANCE.d(TAG, "unknown noise_reduction_mode: " + value2);
                value = null;
                break;
        }
        return value;
    ...
    public SupportedValues setNoiseReductionMode(String value) {
        Logger.INSTANCE.d(TAG, "setNoiseReductionMode: " + value);
                    ...
                    switch (supported_values.selected_value) {
                        ...
                        case "minimal":
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                                ...
                                Logger.INSTANCE.e(TAG, "noise reduction minimal, but pre-Android M!");
                                has_noise_reduction_mode = true;
                                selected_value2 = CameraMetadata.NOISE_REDUCTION_MODE_FAST;
                            }
                            break;
                ...
                if (camera_settings.has_noise_reduction_mode != has_noise_reduction_mode || camera_settings.noise_reduction_mode != selected_value2) {
                    ...
                    if (camera_settings.setNoiseReductionMode(previewBuilder)) {
                        try {
                            ...
                            if (MyDebug.LOG) {
                                Logger.INSTANCE.e(TAG, "failed to set noise_reduction_mode");
                                Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                            }
                            e.printStackTrace();
    ...
    public void setManualISO(boolean manual_iso, int iso) {
        Logger.INSTANCE.d(TAG, "setManualISO: " + manual_iso);
        try {
            if (manual_iso) {
                Range<Integer> iso_range = characteristics.get(CameraCharacteristics.SENSOR_INFO_SENSITIVITY_RANGE); // may be null on some devices
                if (iso_range == null) {
    ...
    public boolean setISO(int iso) {
        Logger.INSTANCE.d(TAG, "setISO: " + iso);
        ...
        try {
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "failed to set ISO");
                Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
            }
            e.printStackTrace();
    ...
    public void setJpegR(boolean want_jpeg_r) {
        ...
        if (hasCaptureSession()) {
            ...
            Logger.INSTANCE.e(TAG, "can't set jpeg_r when captureSession running!");
            throw new RuntimeException(); // throw as RuntimeException, as this is a programming error
        }
    ...
    public void setRaw(boolean want_raw, int max_raw_images) {
        ...
        if (want_raw && this.raw_size == null) {
            Logger.INSTANCE.e(TAG, "can't set raw when raw not supported");
            return;
        }
        if (hasCaptureSession()) {
            // can only call this when captureSession not created - as it affects how we create the imageReader
            Logger.INSTANCE.e(TAG, "can't set raw when captureSession running!");
            throw new RuntimeException(); // throw as RuntimeException, as this is a programming error
        }
    ...
    public void setVideoHighSpeed(boolean want_video_high_speed) {
        Logger.INSTANCE.d(TAG, "setVideoHighSpeed: " + want_video_high_speed);
        if (camera == null) {
            return;
        }
        ...
        if (hasCaptureSession()) {
            ...
            Logger.INSTANCE.e(TAG, "can't set high speed when captureSession running!");
            throw new RuntimeException(); // throw as RuntimeException, as this is a programming error
        }
    ...
    public void setCameraExtension(boolean enabled, int extension) {
        ...
        if (sessionType == (enabled ? SessionType.SESSIONTYPE_EXTENSION : SessionType.SESSIONTYPE_NORMAL) && this.camera_extension == (enabled ? extension : 0)) {
            // quick exit
            Logger.INSTANCE.d(TAG, "    no change");
            return;
        }
        if (hasCaptureSession()) {
            // can only call this when captureSession not created - as it affects how we create the imageReader
            Logger.INSTANCE.e(TAG, "can't set extension when captureSession running!");
            throw new RuntimeException(); // throw as RuntimeException, as this is a programming error
        }

        if (enabled != (sessionType == SessionType.SESSIONTYPE_EXTENSION)) {
            Logger.INSTANCE.d(TAG, "turning extension session on or off");
    ...
    public void setZoom(int value, float smooth_zoom) {
        ...
        if (value < 0 || value > zoom_ratios.size()) {
            Logger.INSTANCE.e(TAG, "invalid zoom value" + value);
            throw new RuntimeException(); // throw as RuntimeException, as this is a programming error
        }
        if (smooth_zoom > 0.0f) {
...
//      Frame duration is in nanoseconds.  Using min to be safe.
    ...
    public List<int[]> getSupportedPreviewFpsRange() {
        Logger.INSTANCE.d(TAG, "getSupportedPreviewFpsRange");
        List<int[]> l = new ArrayList<>();

        List<int[]> rr = want_video_high_speed ? hs_fps_ranges : ae_fps_ranges;
        for (int[] r : rr) {
            int[] ir = {r[0] * 1000, r[1] * 1000};
            Logger.INSTANCE.d(TAG, "    : " + Arrays.toString(ir));
            l.add(ir);
        }
    ...
    public void setFocusValue(String focus_value) {
        ...
        try {
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "failed to set focus mode");
                Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
            }
            e.printStackTrace();
    ...
    public boolean setFocusDistance(float focus_distance) {
        Logger.INSTANCE.d(TAG, "setFocusDistance: " + focus_distance);
        ...
        try {
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "failed to set focus distance");
                Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
            }
            e.printStackTrace();
    ...
    public void setFocusBracketingNImages(int n_images) {
        Logger.INSTANCE.d(TAG, "setFocusBracketingNImages: " + n_images);
        this.focus_bracketing_n_images = n_images;
    }

    @Override
    public void setFocusBracketingAddInfinity(boolean focus_bracketing_add_infinity) {
        Logger.INSTANCE.d(TAG, "setFocusBracketingAddInfinity: " + focus_bracketing_add_infinity);
    ...
    public void setFocusBracketingSourceDistance(float focus_bracketing_source_distance) {
        Logger.INSTANCE.d(TAG, "setFocusBracketingSourceDistance: " + focus_bracketing_source_distance);
    ...
    public void setFocusBracketingTargetDistance(float focus_bracketing_target_distance) {
        Logger.INSTANCE.d(TAG, "setFocusBracketingTargetDistance: " + focus_bracketing_target_distance);
    ...
    private void updateUseFakePrecaptureMode(String flash_value) {
        Logger.INSTANCE.d(TAG, "useFakePrecaptureMode: " + flash_value);
        ...
        Logger.INSTANCE.d(TAG, "use_fake_precapture_mode set to: " + use_fake_precapture_mode);
    }
    ...
    public void setFlashValue(String flash_value) {
        ...
        if (camera_settings.flash_value.equals(flash_value)) {
            Logger.INSTANCE.d(TAG, "flash value already set");
            return;
        }
        ...
        try {
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "failed to set flash mode");
                Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
            }
            e.printStackTrace();
    ...
    public void setAutoExposureLock(boolean enabled) {
        ...
        try {
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "failed to set auto exposure lock");
                Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
            }
            e.printStackTrace();
    ...
    public void setAutoWhiteBalanceLock(boolean enabled) {
        ...
        try {
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "failed to set auto white balance lock");
                Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
            }
            e.printStackTrace();
    ...
    public boolean setFocusAndMeteringArea(List<Area> areas) {
        Logger.INSTANCE.d(TAG, "setFocusAndMeteringArea");
        BLOCK_FOR_EXTENSIONS();
        Rect sensor_rect = getViewableRect();
        Logger.INSTANCE.d(TAG, "sensor_rect: " + sensor_rect.left + " , " + sensor_rect.top + " x " + sensor_rect.right + " , " + sensor_rect.bottom);
        ...
        if (has_focus || has_metering) {
            try {
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.e(TAG, "failed to set focus and/or metering regions");
                    Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                    Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                }
                e.printStackTrace();
    ...
    public void clearFocusAndMetering() {
        Logger.INSTANCE.d(TAG, "clearFocusAndMetering");
        BLOCK_FOR_EXTENSIONS();
        Rect sensor_rect = getViewableRect();
        boolean has_focus = false;
        boolean has_metering = false;
        ...
        if (has_focus || has_metering) {
            try {
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.e(TAG, "failed to clear focus and metering regions");
                    Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                    Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                }
                e.printStackTrace();
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "af_regions: " + Arrays.toString(camera_settings.af_regions));
            Logger.INSTANCE.d(TAG, "ae_regions: " + Arrays.toString(camera_settings.ae_regions));
        }
    }
    ...
    public void setPreviewDisplay(SurfaceHolder holder) {
        if (MyDebug.LOG) {
            ...
            Logger.INSTANCE.e(TAG, "SurfaceHolder not supported for CameraController2!");
            Logger.INSTANCE.e(TAG, "Should use setPreviewTexture() instead");
        }
        throw new RuntimeException(); // throw as RuntimeException, as this is a programming error
    }
    ...
    public void setPreviewTexture(TextureView texture) {
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "setPreviewTexture: " + texture);
            Logger.INSTANCE.d(TAG, "surface: " + texture.getSurfaceTexture());
        }
        if (this.texture != null) {
            Logger.INSTANCE.d(TAG, "preview texture already set");
            throw new RuntimeException(); // throw as RuntimeException, as this is a programming error
        }
    ...
    private void setRepeatingRequest(CaptureRequest request) throws CameraAccessException {
        Logger.INSTANCE.d(TAG, "setRepeatingRequest");
        synchronized (background_camera_lock) {
            if (camera == null || !hasCaptureSession()) {
                Logger.INSTANCE.d(TAG, "no camera or capture session");
                return;
            }
            try {
                if (sessionType == SessionType.SESSIONTYPE_EXTENSION) {
                ...
                Logger.INSTANCE.d(TAG, "setRepeatingRequest done");
            } catch (IllegalStateException e) {
                Logger.INSTANCE.d(TAG, "captureSession already closed!");
                e.printStackTrace();
    ...
    private void capture(CaptureRequest request) throws CameraAccessException {
        Logger.INSTANCE.d(TAG, "capture: " + request);
        synchronized (background_camera_lock) {
            if (camera == null || !hasCaptureSession()) {
                Logger.INSTANCE.d(TAG, "no camera or capture session");
                return;
    ...
    private void createPreviewRequest() {
        Logger.INSTANCE.d(TAG, "createPreviewRequest");
        if (camera == null) {
            Logger.INSTANCE.d(TAG, "camera not available!");
            return;
        }
        Logger.INSTANCE.d(TAG, "camera: " + camera);
        try {
            ...
            Logger.INSTANCE.d(TAG, "successfully created preview request");
        } catch (CameraAccessException e) {
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "failed to create capture request");
                Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
            }
            e.printStackTrace();
    ...
    public void updatePreviewTexture() {
        ...
        if (texture != null) {
            if (preview_width == 0 || preview_height == 0) {
                Logger.INSTANCE.d(TAG, "preview size not yet set");
            } else {
                Logger.INSTANCE.d(TAG, "preview size: " + preview_width + " x " + preview_height);
    ...
    private void createCaptureSession(final MediaRecorder video_recorder, boolean want_photo_video_recording) throws CameraControllerException {
        Logger.INSTANCE.d(TAG, "create capture session");

        if (previewBuilder == null) {
            Logger.INSTANCE.d(TAG, "previewBuilder not present!");
            throw new RuntimeException(); // throw as RuntimeException, as this is a programming error
        }
        if (camera == null) {
            Logger.INSTANCE.e(TAG, "no camera");
        ...
        try {
            ...
            if (texture != null) {
                ...
                Logger.INSTANCE.d(TAG, "set size of preview texture: " + preview_width + " x " + preview_height);
                if (preview_width == 0 || preview_height == 0) {
                    Logger.INSTANCE.e(TAG, "application needs to call setPreviewSize()");
                    throw new RuntimeException(); // throw as RuntimeException, as this is a programming error
                }
                ...
                synchronized (background_camera_lock) {
                    if (surface_texture != null) {
                        Logger.INSTANCE.d(TAG, "remove old target: " + surface_texture);
                        previewBuilder.removeTarget(surface_texture);
                    }
                    this.surface_texture = new Surface(texture);
                    Logger.INSTANCE.d(TAG, "created new target: " + surface_texture);
                }
            }
            if (video_recorder != null) {
                Logger.INSTANCE.d(TAG, "creating capture session for video recording");
            } else {
                Logger.INSTANCE.d(TAG, "picture size: " + imageReader.getWidth() + " x " + imageReader.getHeight());
            }
            /*if( MyDebug.LOG )
            Logger.INSTANCE.d(TAG, "preview size: " + previewImageReader.getWidth() + " x " + previewImageReader.getHeight());*/
            Logger.INSTANCE.d(TAG, "set preview size: " + this.preview_width + " x " + this.preview_height);
            ...
            synchronized (background_camera_lock) {
                ...
                Logger.INSTANCE.d(TAG, "video_recorder_surface: " + video_recorder_surface);
            }
            ...
            class MyStateCallback extends CameraCaptureSession.StateCallback {
                ...
                void onConfigured(@NonNull CameraCaptureSession session, @NonNull CameraExtensionSession eSession) {
                    if (camera == null) {
                        if (MyDebug.LOG) {
                            Logger.INSTANCE.d(TAG, "camera is closed");
                        }
                        synchronized (background_camera_lock) {
                            callback_done = true;
                    ...
                    synchronized (background_camera_lock) {
                        ...
                        if (video_recorder != null) {
                            if (MyDebug.LOG) {
                                Logger.INSTANCE.d(TAG, "add video recorder surface to previewBuilder: " + video_recorder_surface);
                            }
                ...
                public void onConfigured(@NonNull CameraCaptureSession session) {
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.d(TAG, "onConfigured: " + session);
                    }
                ...
                public void onConfigureFailed(@NonNull CameraCaptureSession session) {
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.d(TAG, "onConfigureFailed: " + session);
                    }
                    onConfigureFailed();
                }
                ...
                public void onReady(CameraCaptureSession session) {
                    if( MyDebug.LOG )
                        Logger.INSTANCE.d(TAG, "onReady: " + session);
                    if( pending_request_when_ready != null ) {
                        if( MyDebug.LOG )
                            Logger.INSTANCE.d(TAG, "have pending_request_when_ready: " + pending_request_when_ready);
                        ...
                        try {
                            ...
                            if( MyDebug.LOG ) {
                                Logger.INSTANCE.e(TAG, "failed to take picture");
                                Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                            }
                            e.printStackTrace();
            ...
            if (sessionType == SessionType.SESSIONTYPE_EXTENSION) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                    Logger.INSTANCE.d(TAG, "create extension capture session");
                    ...
                    ExtensionSessionConfiguration extensionConfiguration = new ExtensionSessionConfiguration(
                            ...
                            new CameraExtensionSession.StateCallback() {
                                ...
                                public void onClosed(@NonNull CameraExtensionSession session) {
                                    if (MyDebug.LOG) {
                                        Logger.INSTANCE.d(TAG, "onClosed: " + session);
                                    }
                                }
                            }
                    );
                ...
                Logger.INSTANCE.d(TAG, "create high speed capture session");
                ...
                try {
                    ...
                    // from my code
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.e(TAG, "NullPointerException trying to create capture session");
                        Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                    }
                    e.printStackTrace();
                    throw new CameraControllerException();
            ...
            Logger.INSTANCE.d(TAG, "wait until session created...");
            ...
            if (MyDebug.LOG) {
                if (captureSession != null)
                    Logger.INSTANCE.d(TAG, "created captureSession: " + captureSession);
                if (extensionSession != null)
                    Logger.INSTANCE.d(TAG, "created extensionSession: " + extensionSession);
            }
            if (sessionType == SessionType.SESSIONTYPE_EXTENSION) {
            ...
            synchronized (background_camera_lock) {
                if (!hasCaptureSession()) {
                    Logger.INSTANCE.e(TAG, "failed to create capture session");
                    throw new CameraControllerException();
                }
            }
        } catch (CameraAccessException e) {
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "CameraAccessException trying to create capture session");
                Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
            }
            e.printStackTrace();
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "IllegalArgumentException trying to create capture session");
                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
            }
            e.printStackTrace();
            throw new CameraControllerException();
        ...
        synchronized (background_camera_lock) {
            if (hasCaptureSession()) {
                try {
                    ...
                    ErrorLogger.INSTANCE.logError(TAG, e.getMessage(), e.fillInStackTrace());
                }
                return;
            }
        }
    ...
    public void stopRepeating() {
        Logger.INSTANCE.d(TAG, "stopRepeating: " + this);
        stopPreview(false);
    }

    @Override
    public void stopPreview() {
        Logger.INSTANCE.d(TAG, "stopPreview: " + this);
        stopPreview(true);
    }
    ...
    public void stopPreview(boolean close_capture_session) {
        synchronized (background_camera_lock) {
            ...
            try {
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.e(TAG, "failed to stop repeating");
                    Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                    Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                }
                e.printStackTrace();
            ...
            if (camera_settings.has_face_detect_mode && close_capture_session) {
                Logger.INSTANCE.d(TAG, "cancel face detection");
    ...
    public boolean startFaceDetection() {
        ...
        if (previewBuilder.get(CaptureRequest.STATISTICS_FACE_DETECT_MODE) != null && previewBuilder.get(CaptureRequest.STATISTICS_FACE_DETECT_MODE) != CaptureRequest.STATISTICS_FACE_DETECT_MODE_OFF) {
            Logger.INSTANCE.d(TAG, "face detection already enabled");
            return false;
        }
        if (supports_face_detect_mode_full) {
            Logger.INSTANCE.d(TAG, "use full face detection");
            ...
            Logger.INSTANCE.d(TAG, "use simple face detection");
            camera_settings.has_face_detect_mode = true;
            camera_settings.face_detect_mode = CaptureRequest.STATISTICS_FACE_DETECT_MODE_SIMPLE;
        } else {
            Logger.INSTANCE.e(TAG, "startFaceDetection() called but face detection not available");
            return false;
        }
        camera_settings.setFaceDetectMode(previewBuilder);
        ...
        try {
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "failed to start face detection");
                Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
            }
            e.printStackTrace();
    ...
    public void autoFocus(final AutoFocusCallback cb, boolean capture_follows_autofocus_hint) {
        if (MyDebug.LOG) {
            ...
            Logger.INSTANCE.d(TAG, "capture_follows_autofocus_hint? " + capture_follows_autofocus_hint);
        }
        ...
        synchronized (background_camera_lock) {
            ...
            Integer focus_mode = previewBuilder.get(CaptureRequest.CONTROL_AF_MODE);
            Logger.INSTANCE.d(TAG, "focus mode: " + (focus_mode == null ? "null" : focus_mode));
            if (focus_mode == null) {
                // we preserve the old Camera API where calling autoFocus() on a device without autofocus immediately calls the callback
                // (unclear if ManualCamera needs this, but just to be safe and consistent between camera APIs)
                Logger.INSTANCE.d(TAG, "no focus mode");
                cb.onAutoFocus(true);
                return;
            } else if (sessionType == SessionType.SESSIONTYPE_EXTENSION) {
                Logger.INSTANCE.d(TAG, "no auto focus for extensions");
                cb.onAutoFocus(true);
                return;
                ...
                Logger.INSTANCE.d(TAG, "skip af trigger due to continuous mode");
            ...
            /*if( state == STATE_WAITING_AUTOFOCUS ) {
                if( MyDebug.LOG )
                    Logger.INSTANCE.d(TAG, "already waiting for an autofocus");
            ...
            if (MyDebug.LOG) {
                {
                    ...
                    for (int i = 0; areas != null && i < areas.length; i++) {
                        Logger.INSTANCE.d(TAG, i + " focus area: " + areas[i].getX() + " , " + areas[i].getY() + " : " + areas[i].getWidth() + " x " + areas[i].getHeight() + " weight " + areas[i].getMeteringWeight());
                    }
                }
                {
                    MeteringRectangle[] areas = afBuilder.get(CaptureRequest.CONTROL_AE_REGIONS);
                    for (int i = 0; areas != null && i < areas.length; i++) {
                        Logger.INSTANCE.d(TAG, i + " metering area: " + areas[i].getX() + " , " + areas[i].getY() + " : " + areas[i].getWidth() + " x " + areas[i].getHeight() + " weight " + areas[i].getMeteringWeight());
                    }
                }
            }
            Logger.INSTANCE.d(TAG, "state is now STATE_WAITING_AUTOFOCUS");
            ...
            try {
                if (use_fake_precapture_mode) {
                    ...
                    if (want_flash) {
                        Logger.INSTANCE.d(TAG, "turn on torch for fake flash");
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.e(TAG, "failed to autofocus");
                    Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                    Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                }
                e.printStackTrace();
    ...
    public void setCaptureFollowAutofocusHint(boolean capture_follows_autofocus_hint) {
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "setCaptureFollowAutofocusHint");
            Logger.INSTANCE.d(TAG, "capture_follows_autofocus_hint? " + capture_follows_autofocus_hint);
        }
        BLOCK_FOR_EXTENSIONS();
        synchronized (background_camera_lock) {
    ...
    public void cancelAutoFocus() {
        ...
        synchronized (background_camera_lock) {
            ...
            if (is_video_high_speed) {
                Logger.INSTANCE.d(TAG, "video is high speed");
                return;
            }

            if (sessionType == SessionType.SESSIONTYPE_EXTENSION) {
                Logger.INSTANCE.d(TAG, "session type extension");
                return;
            }
            ...
            try {
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.e(TAG, "failed to cancel autofocus [capture]");
                    Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                    Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                }
                e.printStackTrace();
            } catch (IllegalStateException e) {
                Logger.INSTANCE.d(TAG, "failed to cancel autofocus [captureSession already closed!]");
                e.printStackTrace();
            ...
            try {
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.e(TAG, "failed to set repeating request after cancelling autofocus");
                    Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                    Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                }
                e.printStackTrace();
    ...
    private void adjustPreviewToStill(CaptureRequest stillRequest, PostCapture post_capture) throws CameraAccessException {
        Logger.INSTANCE.d(TAG, "adjustPreviewToStill");
    ...
    private void takePictureAfterPrecapture() {
        Logger.INSTANCE.d(TAG, "takePictureAfterPrecapture");
        long debug_time = 0;
        if (MyDebug.LOG) {
            debug_time = System.currentTimeMillis();
        }
        ...
        if (!previewIsVideoMode) {
            ...
            if (burst_type == BurstType.BURSTTYPE_EXPO || burst_type == BurstType.BURSTTYPE_FOCUS) {
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.d(TAG, "takePictureAfterPrecapture() took: " + (System.currentTimeMillis() - debug_time));
                }
                return;
        ...
        synchronized (background_camera_lock) {
            ...
            try {
                if (MyDebug.LOG) {
                    if (imageReaderRaw != null) {
                        Logger.INSTANCE.d(TAG, "imageReaderRaw: " + imageReaderRaw);
                        Logger.INSTANCE.d(TAG, "imageReaderRaw surface: " + imageReaderRaw.getSurface().toString());
                    } else {
                        Logger.INSTANCE.d(TAG, "imageReader: " + imageReader.toString());
                        Logger.INSTANCE.d(TAG, "imageReader surface: " + imageReader.getSurface().toString());
                    }
                }
                ...
                if (use_fake_precapture_mode && fake_precapture_torch_performed) {
                    Logger.INSTANCE.d(TAG, "setting torch for capture");
                    if (!camera_settings.has_iso)
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O && sessionType != SessionType.SESSIONTYPE_EXTENSION) {
                    ...
                    if (MyDebug.LOG) {
                        ...
                        Logger.INSTANCE.d(TAG, "CONTROL_ENABLE_ZSL: " + (zsl == null ? "null" : zsl));
                    }
                }
                clearPending();
            ...
            synchronized (background_camera_lock) {
                ...
                if (test_release_during_photo) {
                    ...
                    activity.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Logger.INSTANCE.d(TAG, "test UI thread call release()");
                            release();
                        }
                    });
                    try {
                ...
                try {
                    Logger.INSTANCE.d(TAG, "capture with stillBuilder");
                    ...
                    if (sessionType == SessionType.SESSIONTYPE_EXTENSION) {
                        ...
                        if (adjust_preview) {
                            Logger.INSTANCE.d(TAG, "long manual exposure workaround: adjust preview first");
    ...
    public static List<Float> setupFocusBracketingDistances(float source, float target, int count) {
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "focus_distance_s: " + focus_distance_s);
            Logger.INSTANCE.d(TAG, "focus_distance_e: " + focus_distance_e);
        }
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "real_focus_distance_s: " + real_focus_distance_s);
            Logger.INSTANCE.d(TAG, "real_focus_distance_e: " + real_focus_distance_e);
        }
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.d(TAG, "    alpha: " + alpha);
                    Logger.INSTANCE.d(TAG, "    real_distance: " + real_distance);
                }
                distance = 1.0f / real_distance;
            }
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "    distance: " + distance);
            }
    ...
    private void takePictureBurstBracketing() {
        Logger.INSTANCE.d(TAG, "takePictureBurstBracketing");
        if (burst_type != BurstType.BURSTTYPE_EXPO && burst_type != BurstType.BURSTTYPE_FOCUS) {
            Logger.INSTANCE.e(TAG, "takePictureBurstBracketing called but unexpected burst_type: " + burst_type);
        }
        BLOCK_FOR_EXTENSIONS(); // not supported for extension sessions
        ...
        synchronized (background_camera_lock) {
            ...
            try {
                ...
                if (burst_type == BurstType.BURSTTYPE_EXPO) {
                    ...
                    Logger.INSTANCE.d(TAG, "expo bracketing");
                ...
                requests.add( stillBuilder.build() );*/
                    ...
                    Range<Integer> iso_range = characteristics.get(CameraCharacteristics.SENSOR_INFO_SENSITIVITY_RANGE); // may be null on some devices
                    if (iso_range == null) {
                        Logger.INSTANCE.e(TAG, "takePictureBurstBracketing called but null iso_range");
                    } else {
                        // set ISO
                        int iso = 800;
                    ...
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.d(TAG, "taking expo bracketing with n_images: " + expo_bracketing_n_images);
                        Logger.INSTANCE.d(TAG, "ISO: " + stillBuilder.get(CaptureRequest.SENSOR_SENSITIVITY));
                        Logger.INSTANCE.d(TAG, "Frame duration: " + stillBuilder.get(CaptureRequest.SENSOR_FRAME_DURATION));
                        Logger.INSTANCE.d(TAG, "Base exposure time: " + base_exposure_time);
                        Logger.INSTANCE.d(TAG, "Min exposure time: " + min_exposure_time);
                        Logger.INSTANCE.d(TAG, "Max exposure time: " + max_exposure_time);
                    }

                    if (dummy_capture_hack && use_expo_fast_burst) {
                        Logger.INSTANCE.d(TAG, "add dummy capture");
                    ...
                    for (int i = 0; i < n_half_images; i++) {
                        ...
                        if (supports_exposure_time) {
                            ...
                            if (MyDebug.LOG) {
                                ...
                                Logger.INSTANCE.d(TAG, "    this_scale: " + this_scale);
                    ...
                    // base image
                    Logger.INSTANCE.d(TAG, "add burst request for base image");
                    ...
                    for (int i = 0; i < n_half_images; i++) {
                        ...
                        if (supports_exposure_time) {
                            ...
                            if (i == n_half_images - 1) {
                                ...
                                Logger.INSTANCE.d(TAG, "set RequestTagType.CAPTURE for last burst request");
                                stillBuilder.setTag(new RequestTagObject(RequestTagType.CAPTURE));
                            } else {
                                stillBuilder.setTag(new RequestTagObject(RequestTagType.CAPTURE_BURST_IN_PROGRESS));
                            }
                    ...
                    if (Math.abs(camera_settings.focus_distance - focus_bracketing_source_distance) < 1.0e-5) {
                        Logger.INSTANCE.d(TAG, "current focus matches source");
                    } else if (Math.abs(camera_settings.focus_distance - focus_bracketing_target_distance) < 1.0e-5) {
                        Logger.INSTANCE.d(TAG, "current focus matches target");
                    } else {
                        Logger.INSTANCE.d(TAG, "current focus matches neither source nor target");
                    }
                ...
                */
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.e(TAG, "failed to take picture expo burst");
                    Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                    Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                }
                e.printStackTrace();
            ...
            synchronized (background_camera_lock) {
                ...
                try {
                    ...
                    if (use_expo_fast_burst && burst_type == BurstType.BURSTTYPE_EXPO) { // always use slow burst for focus bracketing
                        Logger.INSTANCE.d(TAG, "using fast burst");
                        int sequenceId = captureSession.captureBurst(requests, previewCaptureCallback, handler);
                        Logger.INSTANCE.d(TAG, "sequenceId: " + sequenceId);
                    } else {
                        Logger.INSTANCE.d(TAG, "using slow burst");
    ...
    private void doTakePhotoBurst(CaptureRequest request, CaptureRequest last_request) throws CameraAccessException {
        if (burst_type == BurstType.BURSTTYPE_CONTINUOUS) {
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "continuous capture");
                if (!continuous_burst_in_progress)
                    Logger.INSTANCE.d(TAG, "    last continuous capture");
            }
            ...
            if (continuous_burst_in_progress) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (MyDebug.LOG) {
                            Logger.INSTANCE.d(TAG, "take next continuous burst");
                            Logger.INSTANCE.d(TAG, "continuous_burst_in_progress: " + continuous_burst_in_progress);
                            Logger.INSTANCE.d(TAG, "n_burst: " + n_burst);
                        }
                        if (n_burst >= 10 || n_burst_raw >= 10) {
                            ...
                            if (MyDebug.LOG) {
                                Logger.INSTANCE.d(TAG, "...but wait for continuous burst, as waiting for too many photos");
                            }
                            //throw new RuntimeException(); // test
                            handler.postDelayed(this, continuous_burst_rate_ms);
                        } else if (picture_cb.imageQueueWouldBlock(n_burst_raw, n_burst + 1)) {
                            if (MyDebug.LOG) {
                                Logger.INSTANCE.d(TAG, "...but wait for continuous burst, as image queue would block");
                            }
                            //throw new RuntimeException(); // test
                            handler.postDelayed(this, continuous_burst_rate_ms);
                        } else {
            ...
            Logger.INSTANCE.d(TAG, "captureBurst");
            int sequenceId = captureSession.captureBurst(requests, previewCaptureCallback, handler);
            Logger.INSTANCE.d(TAG, "sequenceId: " + sequenceId);
        }
    }
    ...
    private void takePictureBurst(boolean continuing_fast_burst) {
        Logger.INSTANCE.d(TAG, "takePictureBurst");
        ...
        synchronized (background_camera_lock) {
            ...
            try {
                ...
                if (!is_samsung && burst_type == BurstType.BURSTTYPE_NORMAL && burst_for_noise_reduction) {
                    ...
                    Logger.INSTANCE.d(TAG, "optimise settings for burst_for_noise_reduction");
                ...
                if (burst_type == BurstType.BURSTTYPE_CONTINUOUS) {
                    ...
                    Logger.INSTANCE.d(TAG, "choose n_burst for burst_for_noise_reduction");
                    n_burst = 4;
                    n_burst_taken = 0;
                    ...
                    if (capture_result_has_iso && capture_result_has_exposure_time) {
                        if (HDRProcessor.sceneIsLowLight(capture_result_iso, capture_result_exposure_time)) {
                            Logger.INSTANCE.d(TAG, "optimise for dark scene");
                            ...
                            if (exposure_time <= fixed_exposure_time) {
                                Logger.INSTANCE.d(TAG, "optimise for bright scene");
                                //n_burst = 2;
                                n_burst = 3;
                    ...
                    Logger.INSTANCE.d(TAG, "user requested n_burst");
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.e(TAG, "failed to take picture burst");
                    Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                    Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                }
                e.printStackTrace();
    ...
    private void runPrecapture() {
        Logger.INSTANCE.d(TAG, "runPrecapture");
        ...
        synchronized (background_camera_lock) {
            if (MyDebug.LOG) {
                if (use_fake_precapture_mode)
                    Logger.INSTANCE.e(TAG, "shouldn't be doing standard precapture when use_fake_precapture_mode is true!");
                else if (burst_type != BurstType.BURSTTYPE_NONE)
                    Logger.INSTANCE.e(TAG, "shouldn't be doing precapture for burst - should be using fake precapture!");
            }
            try {
                ...
                Logger.INSTANCE.d(TAG, "capture with precaptureBuilder");
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.e(TAG, "failed to precapture");
                    Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                    Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                }
                e.printStackTrace();
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "runPrecapture() took: " + (System.currentTimeMillis() - debug_time));
        }
    }

    private void runFakePrecapture() {
        Logger.INSTANCE.d(TAG, "runFakePrecapture");
        ...
        synchronized (background_camera_lock) {
            switch (camera_settings.flash_value) {
                case "flash_auto":
                case "flash_on":
                    Logger.INSTANCE.d(TAG, "turn on torch");
                    if (!camera_settings.has_iso) {
                        // in auto-mode, need to ensure CONTROL_AE_MODE isn't est to flash auto/on for torch to work
                        // in manual-mode, fine as CONTROL_AE_MODE will be off
                ...
                case "flash_frontscreen_on":
                    ...
                    break;
                default:
                    Logger.INSTANCE.e(TAG, "runFakePrecapture called with unexpected flash value: " + camera_settings.flash_value);
                    break;
            }
        }
        ...
        if (turn_frontscreen_on) {
            if (picture_cb != null) {
                Logger.INSTANCE.d(TAG, "request screen turn on for frontscreen flash");
                picture_cb.onFrontScreenTurnOn();
            } else {
                Logger.INSTANCE.e(TAG, "can't request screen turn on for frontscreen flash, as no picture_cb");
            }
        }
        ...
        synchronized (background_camera_lock) {
            ...
            try {
                ...
                if (fake_precapture_torch_performed) {
                    ...
                    Logger.INSTANCE.d(TAG, "fake_precapture_turn_on_torch_id: " + request);
                }
                setRepeatingRequest(request);
            } catch (CameraAccessException e) {
                if (MyDebug.LOG) {
                    Logger.INSTANCE.e(TAG, "failed to start fake precapture");
                    Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                    Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                }
                e.printStackTrace();
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "runFakePrecapture() took: " + (System.currentTimeMillis() - debug_time));
        }
    }
    ...
    private boolean fireAutoFlash() {
        Logger.INSTANCE.d(TAG, "fireAutoFlash");
        long time_now = System.currentTimeMillis();
        if (MyDebug.LOG && fake_precapture_use_flash_time_ms != -1) {
            Logger.INSTANCE.d(TAG, "fake_precapture_use_flash_time_ms: " + fake_precapture_use_flash_time_ms);
            Logger.INSTANCE.d(TAG, "time_now: " + time_now);
            Logger.INSTANCE.d(TAG, "time since last flash auto decision: " + (time_now - fake_precapture_use_flash_time_ms));
        }
        ...
        if (fake_precapture_use_flash_time_ms != -1 && time_now - fake_precapture_use_flash_time_ms < cache_time_ms) {
            Logger.INSTANCE.d(TAG, "use recent decision: " + fake_precapture_use_flash);
        ...
        switch (camera_settings.flash_value) {
            ...
            case "flash_frontscreen_auto":
                ...
                Logger.INSTANCE.d(TAG, "    ISO was: " + capture_result_iso);
                break;
            default:
        ...
        Logger.INSTANCE.d(TAG, "fake_precapture_use_flash: " + fake_precapture_use_flash);
    ...
    public void takePicture(final PictureCallback picture, final ErrorCallback error) {
        ...
        synchronized (background_camera_lock) {
            ...
            if (sessionType == SessionType.SESSIONTYPE_NORMAL && !ready_for_capture) {
                Logger.INSTANCE.e(TAG, "takePicture: not ready for capture!");
                //throw new RuntimeException(); // debugging
            }

            {
                if (MyDebug.LOG) {
                    Logger.INSTANCE.d(TAG, "current flash value: " + camera_settings.flash_value);
                    Logger.INSTANCE.d(TAG, "use_fake_precapture_mode: " + use_fake_precapture_mode);
                }
                if (sessionType == SessionType.SESSIONTYPE_EXTENSION) {
                    ...
                    Logger.INSTANCE.d(TAG, "flash_mode: " + flash_mode);
                    if (auto_flash && !fireAutoFlash()) {
                        Logger.INSTANCE.d(TAG, "fake precapture flash auto: seems bright enough to not need flash");
                        call_takePictureAfterPrecapture = true;
                    } else if (flash_mode != null && flash_mode == CameraMetadata.FLASH_MODE_TORCH) {
                        Logger.INSTANCE.d(TAG, "fake precapture flash: torch already on (presumably from autofocus)");
                    ...
                    if (camera_settings.flash_value.equals("flash_auto") && !needs_flash) {
                        ...
                        Logger.INSTANCE.d(TAG, "flash auto, but we don't need flash");
                        call_takePictureAfterPrecapture = true;
                    } else {
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "takePicture() took: " + (System.currentTimeMillis() - debug_time));
        }
    }
    ...
    public void setDisplayOrientation(int degrees) {
        ...
        Logger.INSTANCE.d(TAG, "setDisplayOrientation not supported by this API");
        ErrorLogger.INSTANCE.logError(TAG, "setDisplayOrientation throw as RuntimeException, as this is a programming error", null);
    }

    @Override
    public int getDisplayOrientation() {
        Logger.INSTANCE.d(TAG, "getDisplayOrientation not supported by this API");
        ErrorLogger.INSTANCE.logError(TAG, "getDisplayOrientation throw as RuntimeException, as this is a programming error", null);
        return 0;
    }
    ...
    public void initVideoRecorderPostPrepare(MediaRecorder video_recorder, boolean want_photo_video_recording) throws CameraControllerException {
        Logger.INSTANCE.d(TAG, "initVideoRecorderPostPrepare");
        if (camera == null) {
            Logger.INSTANCE.e(TAG, "no camera");
            return;
        }
        BLOCK_FOR_EXTENSIONS(); // not supported for extension sessions
        try {
            Logger.INSTANCE.d(TAG, "obtain video_recorder surface");
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "failed to create capture request for video");
                Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
            }
        }
    ...
    */
    ...
    private class MyExtensionCaptureCallback extends CameraExtensionSession.ExtensionCaptureCallback {
        ...
        public void onCaptureStarted(@NonNull CameraExtensionSession session,
            ...
            if (!has_received_frame) {
                ...
                Logger.INSTANCE.d(TAG, "has_received_frame now set to true");
            }
        ...
        public void onCaptureFailed(@NonNull CameraExtensionSession session,
                                    @NonNull CaptureRequest request) {
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "onCaptureFailed");
            }
        ...
        public void onCaptureSequenceCompleted(@NonNull CameraExtensionSession session,
                                               int sequenceId) {
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "onCaptureSequenceCompleted");
                Logger.INSTANCE.d(TAG, "sequenceId: " + sequenceId);
            }
        ...
        public void onCaptureSequenceAborted(@NonNull CameraExtensionSession session,
                                             int sequenceId) {
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "onCaptureSequenceAborted");
                Logger.INSTANCE.d(TAG, "sequenceId: " + sequenceId);
            }
        ...
        public void onCaptureProcessProgressed(@NonNull CameraExtensionSession session,
            ...
            Logger.INSTANCE.d(TAG, "onCaptureProcessProgressed: " + progress);

            final Activity activity = (Activity) context;
            activity.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Logger.INSTANCE.d(TAG, "onCaptureProcessProgressed UI thread: " + progress);
                    if (picture_cb != null) {
    ...
    private class MyCaptureCallback extends CameraCaptureSession.CaptureCallback {
        ...
        public void onCaptureBufferLost(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull Surface target, long frameNumber) {
            Logger.INSTANCE.d(TAG, "onCaptureBufferLost: " + frameNumber);
        ...
        public void onCaptureFailed(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull CaptureFailure failure) {
            if (MyDebug.LOG) {
                Logger.INSTANCE.e(TAG, "onCaptureFailed: " + failure);
                Logger.INSTANCE.d(TAG, "reason: " + failure.getReason());
                Logger.INSTANCE.d(TAG, "was image captured?: " + failure.wasImageCaptured());
                Logger.INSTANCE.d(TAG, "sequenceId: " + failure.getSequenceId());
            }
        ...
        public void onCaptureSequenceCompleted(@NonNull CameraCaptureSession session, int sequenceId, long frameNumber) {
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "onCaptureSequenceCompleted");
                Logger.INSTANCE.d(TAG, "sequenceId: " + sequenceId);
                Logger.INSTANCE.d(TAG, "frameNumber: " + frameNumber);
            }
        ...
        public void onCaptureStarted(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, long timestamp, long frameNumber) {
            if (MyDebug.LOG) {
                if (getRequestTagType(request) == RequestTagType.CAPTURE) {
                    Logger.INSTANCE.d(TAG, "onCaptureStarted: capture");
                    Logger.INSTANCE.d(TAG, "frameNumber: " + frameNumber);
                    Logger.INSTANCE.d(TAG, "exposure time: " + request.get(CaptureRequest.SENSOR_EXPOSURE_TIME));
        ...
        public void onCaptureProgressed(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull CaptureResult partialResult) {
            /*if( MyDebug.LOG )
                Logger.INSTANCE.d(TAG, "onCaptureProgressed");*/
        ...
        public void onCaptureCompleted(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull TotalCaptureResult result) {
            /*if( MyDebug.LOG )
                Logger.INSTANCE.d(TAG, "onCaptureCompleted");*/
            if (MyDebug.LOG) {
                if (getRequestTagType(request) == RequestTagType.CAPTURE) {
                    Logger.INSTANCE.d(TAG, "onCaptureCompleted: capture");
                    Logger.INSTANCE.d(TAG, "sequenceId: " + result.getSequenceId());
                    Logger.INSTANCE.d(TAG, "frameNumber: " + result.getFrameNumber());
                    Logger.INSTANCE.d(TAG, "exposure time: " + request.get(CaptureRequest.SENSOR_EXPOSURE_TIME));
                    Logger.INSTANCE.d(TAG, "frame duration: " + request.get(CaptureRequest.SENSOR_FRAME_DURATION));
                } else if (getRequestTagType(request) == RequestTagType.CAPTURE_BURST_IN_PROGRESS) {
                    Logger.INSTANCE.d(TAG, "onCaptureCompleted: capture burst in progress");
                    Logger.INSTANCE.d(TAG, "sequenceId: " + result.getSequenceId());
                    Logger.INSTANCE.d(TAG, "frameNumber: " + result.getFrameNumber());
                    Logger.INSTANCE.d(TAG, "exposure time: " + request.get(CaptureRequest.SENSOR_EXPOSURE_TIME));
                    Logger.INSTANCE.d(TAG, "frame duration: " + request.get(CaptureRequest.SENSOR_FRAME_DURATION));
        ...
        private void updateCachedAECaptureStatus(CaptureResult result) {
            ...
            /*if( MyDebug.LOG ) {
                if( ae_state == null )
                    Logger.INSTANCE.d(TAG, "CONTROL_AE_STATE is null");
                else if( ae_state == CaptureResult.CONTROL_AE_STATE_INACTIVE )
                    Logger.INSTANCE.d(TAG, "CONTROL_AE_STATE = CONTROL_AE_STATE_INACTIVE");
                else if( ae_state == CaptureResult.CONTROL_AE_STATE_SEARCHING )
                    Logger.INSTANCE.d(TAG, "CONTROL_AE_STATE = CONTROL_AE_STATE_SEARCHING");
                else if( ae_state == CaptureResult.CONTROL_AE_STATE_CONVERGED )
                    Logger.INSTANCE.d(TAG, "CONTROL_AE_STATE = CONTROL_AE_STATE_CONVERGED");
                else if( ae_state == CaptureResult.CONTROL_AE_STATE_LOCKED )
                    Logger.INSTANCE.d(TAG, "CONTROL_AE_STATE = CONTROL_AE_STATE_LOCKED");
                else if( ae_state == CaptureResult.CONTROL_AE_STATE_FLASH_REQUIRED )
                    Logger.INSTANCE.d(TAG, "CONTROL_AE_STATE = CONTROL_AE_STATE_FLASH_REQUIRED");
                else if( ae_state == CaptureResult.CONTROL_AE_STATE_PRECAPTURE )
                    Logger.INSTANCE.d(TAG, "CONTROL_AE_STATE = CONTROL_AE_STATE_PRECAPTURE");
                else
                    Logger.INSTANCE.d(TAG, "CONTROL_AE_STATE = " + ae_state);
            }*/
            Integer flash_mode = result.get(CaptureResult.FLASH_MODE);
            /*if( MyDebug.LOG ) {
                if( flash_mode == null )
                    Logger.INSTANCE.d(TAG, "FLASH_MODE is null");
                else if( flash_mode == CaptureResult.FLASH_MODE_OFF )
                    Logger.INSTANCE.d(TAG, "FLASH_MODE = FLASH_MODE_OFF");
                else if( flash_mode == CaptureResult.FLASH_MODE_SINGLE )
                    Logger.INSTANCE.d(TAG, "FLASH_MODE = FLASH_MODE_SINGLE");
                else if( flash_mode == CaptureResult.FLASH_MODE_TORCH )
                    Logger.INSTANCE.d(TAG, "FLASH_MODE = FLASH_MODE_TORCH");
                else
                    Logger.INSTANCE.d(TAG, "FLASH_MODE = " + flash_mode);
            }*/
            ...
            if (use_fake_precapture_mode && (fake_precapture_torch_focus_performed || fake_precapture_torch_performed) && flash_mode != null && flash_mode == CameraMetadata.FLASH_MODE_TORCH) {
                ...
                Logger.INSTANCE.d(TAG, "CONTROL_AE_STATE changed from " + capture_result_ae + " to " + ae_state);
        ...
        private void handleStateChange(CaptureRequest request, CaptureResult result) {
            ...
            /*if( MyDebug.LOG ) {
                if( af_state == null )
                    Logger.INSTANCE.d(TAG, "CONTROL_AF_STATE is null");
                else if( af_state == CaptureResult.CONTROL_AF_STATE_INACTIVE )
                    Logger.INSTANCE.d(TAG, "CONTROL_AF_STATE = CONTROL_AF_STATE_INACTIVE");
                else if( af_state == CaptureResult.CONTROL_AF_STATE_PASSIVE_SCAN )
                    Logger.INSTANCE.d(TAG, "CONTROL_AF_STATE = CONTROL_AF_STATE_PASSIVE_SCAN");
                else if( af_state == CaptureResult.CONTROL_AF_STATE_PASSIVE_FOCUSED )
                    Logger.INSTANCE.d(TAG, "CONTROL_AF_STATE = CONTROL_AF_STATE_PASSIVE_FOCUSED");
                else if( af_state == CaptureResult.CONTROL_AF_STATE_ACTIVE_SCAN )
                    Logger.INSTANCE.d(TAG, "CONTROL_AF_STATE = CONTROL_AF_STATE_ACTIVE_SCAN");
                else if( af_state == CaptureResult.CONTROL_AF_STATE_FOCUSED_LOCKED )
                    Logger.INSTANCE.d(TAG, "CONTROL_AF_STATE = CONTROL_AF_STATE_FOCUSED_LOCKED");
                else if( af_state == CaptureResult.CONTROL_AF_STATE_NOT_FOCUSED_LOCKED )
                    Logger.INSTANCE.d(TAG, "CONTROL_AF_STATE = CONTROL_AF_STATE_NOT_FOCUSED_LOCKED");
                else if( af_state == CaptureResult.CONTROL_AF_STATE_PASSIVE_UNFOCUSED )
                    Logger.INSTANCE.d(TAG, "CONTROL_AF_STATE = CONTROL_AF_STATE_PASSIVE_UNFOCUSED");
                else
                    Logger.INSTANCE.d(TAG, "CONTROL_AF_STATE = " + af_state);
            }*/
            ...
            if( MyDebug.LOG ) {
                if( awb_state == null )
                    Logger.INSTANCE.d(TAG, "CONTROL_AWB_STATE is null");
                else if( awb_state == CaptureResult.CONTROL_AWB_STATE_INACTIVE )
                    Logger.INSTANCE.d(TAG, "CONTROL_AWB_STATE = CONTROL_AWB_STATE_INACTIVE");
                else if( awb_state == CaptureResult.CONTROL_AWB_STATE_SEARCHING )
                    Logger.INSTANCE.d(TAG, "CONTROL_AWB_STATE = CONTROL_AWB_STATE_SEARCHING");
                else if( awb_state == CaptureResult.CONTROL_AWB_STATE_CONVERGED )
                    Logger.INSTANCE.d(TAG, "CONTROL_AWB_STATE = CONTROL_AWB_STATE_CONVERGED");
                else if( awb_state == CaptureResult.CONTROL_AWB_STATE_LOCKED )
                    Logger.INSTANCE.d(TAG, "CONTROL_AWB_STATE = CONTROL_AWB_STATE_LOCKED");
                else
                    Logger.INSTANCE.d(TAG, "CONTROL_AWB_STATE = " + awb_state);
            }*/
            ...
            if (MyDebug.LOG && autofocus_timeout)
                Logger.INSTANCE.d(TAG, "autofocus timeout!");
            if (af_state != null && af_state == CaptureResult.CONTROL_AF_STATE_PASSIVE_SCAN && !autofocus_timeout) {
                /*if( MyDebug.LOG )
                    Logger.INSTANCE.d(TAG, "not ready for capture: " + af_state);*/
                ready_for_capture = false;
            } else {
                /*if( MyDebug.LOG )
                    Logger.INSTANCE.d(TAG, "ready for capture: " + af_state);*/
                ...
                if (autofocus_cb != null && (!do_af_trigger_for_continuous || use_fake_precapture_mode) && focusIsContinuous()) {
                    ...
                    if (focus_mode != null && focus_mode == CaptureRequest.CONTROL_AF_MODE_CONTINUOUS_PICTURE) {
                        Logger.INSTANCE.d(TAG, "call autofocus callback, as continuous mode and not focusing: " + af_state);
                        ...
                        if (MyDebug.LOG) {
                            if (focus_success)
                                Logger.INSTANCE.d(TAG, "autofocus success");
                            else
                                Logger.INSTANCE.d(TAG, "autofocus failed");
                            if (af_state == null)
                                Logger.INSTANCE.e(TAG, "continuous focus mode but af_state is null");
                            else
                                Logger.INSTANCE.d(TAG, "af_state: " + af_state);
                        }
                        if (af_state == null) {
            ...
            /*if( MyDebug.LOG ) {
                if( autofocus_cb == null ) {
                    if( af_state == CaptureResult.CONTROL_AF_STATE_FOCUSED_LOCKED )
                        Logger.INSTANCE.d(TAG, "processAF: autofocus success but no callback set");
                    else if( af_state == CaptureResult.CONTROL_AF_STATE_NOT_FOCUSED_LOCKED )
                        Logger.INSTANCE.d(TAG, "processAF: autofocus failed but no callback set");
                }
            }*/

            if (fake_precapture_turn_on_torch_id != null && fake_precapture_turn_on_torch_id == request) {
                Logger.INSTANCE.d(TAG, "torch turned on for fake precapture");
                fake_precapture_turn_on_torch_id = null;
            }
            ...
            if (state == STATE_NORMAL) {
                ...
                if (af_state == null) {
                    ...
                    Logger.INSTANCE.e(TAG, "waiting for autofocus but af_state is null");
                    test_af_state_null_focus++;
                    state = STATE_NORMAL;
                    precapture_state_change_time_ms = -1;
                    if (autofocus_cb != null) {
                    ...
                    if (autofocus_timeout || af_state == CaptureResult.CONTROL_AF_STATE_FOCUSED_LOCKED || af_state == CaptureResult.CONTROL_AF_STATE_NOT_FOCUSED_LOCKED /*||
                        ...
                        if (MyDebug.LOG) {
                            if (focus_success)
                                Logger.INSTANCE.d(TAG, "onCaptureCompleted: autofocus success");
                            else
                                Logger.INSTANCE.d(TAG, "onCaptureCompleted: autofocus failed");
                            Logger.INSTANCE.d(TAG, "af_state: " + af_state);
                        }
                        state = STATE_NORMAL;
                        precapture_state_change_time_ms = -1;
                        if (use_fake_precapture_mode && fake_precapture_torch_focus_performed) {
                            ...
                            if (!capture_follows_autofocus_hint) {
                                ...
                                Logger.INSTANCE.d(TAG, "turn off torch after focus (fake precapture code)");
                                ...
                                try {
                                    ...
                                    if (MyDebug.LOG) {
                                        Logger.INSTANCE.e(TAG, "failed to do capture to turn off torch after autofocus");
                                        Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                                        Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                                    }
                                    e.printStackTrace();
                                ...
                                try {
                                    ...
                                    if (MyDebug.LOG) {
                                        Logger.INSTANCE.e(TAG, "failed to set repeating request to turn off torch after autofocus");
                                        Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                                        Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                                    }
                                    e.printStackTrace();
                                ...
                                Logger.INSTANCE.d(TAG, "torch was enabled for autofocus, leave it on for capture (fake precapture code)");
                            }
                        }
                        if (autofocus_cb != null) {
                            autofocus_cb.onAutoFocus(focus_success);
                ...
                Logger.INSTANCE.d(TAG, "waiting for precapture start...");
                if (MyDebug.LOG) {
                    if (ae_state != null)
                        Logger.INSTANCE.d(TAG, "CONTROL_AE_STATE = " + ae_state);
                    else
                ...
                if (ae_state == null || ae_state == CaptureResult.CONTROL_AE_STATE_PRECAPTURE /*|| ae_state == CaptureResult.CONTROL_AE_STATE_FLASH_REQUIRED*/) {
                    ...
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.d(TAG, "precapture started after: " + (System.currentTimeMillis() - precapture_state_change_time_ms));
                    }
                    ...
                    Logger.INSTANCE.e(TAG, "precapture start timeout");
                    count_precapture_timeout++;
                    state = STATE_WAITING_PRECAPTURE_DONE;
                    precapture_state_change_time_ms = System.currentTimeMillis();
                }
            } else if (state == STATE_WAITING_PRECAPTURE_DONE) {
                Logger.INSTANCE.d(TAG, "waiting for precapture done...");
                if (MyDebug.LOG) {
                    if (ae_state != null)
                        Logger.INSTANCE.d(TAG, "CONTROL_AE_STATE = " + ae_state);
                    else
                ...
                if (ae_state == null || ae_state != CaptureResult.CONTROL_AE_STATE_PRECAPTURE) {
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.d(TAG, "precapture completed after: " + (System.currentTimeMillis() - precapture_state_change_time_ms));
                    }
                    state = STATE_NORMAL;
                    precapture_state_change_time_ms = -1;
                    takePictureAfterPrecapture();
                    ...
                    // just in case
                    // always log error, so we can look for it when manually testing with logging disabled
                    Logger.INSTANCE.e(TAG, "precapture done timeout");
                    count_precapture_timeout++;
                    state = STATE_NORMAL;
                    precapture_state_change_time_ms = -1;
                    takePictureAfterPrecapture();
                ...
                Logger.INSTANCE.d(TAG, "waiting for fake precapture start...");
                if (MyDebug.LOG) {
                    if (ae_state != null)
                        Logger.INSTANCE.d(TAG, "CONTROL_AE_STATE = " + ae_state);
                    else
                ...
                if (fake_precapture_turn_on_torch_id != null) {
                    Logger.INSTANCE.d(TAG, "still waiting for torch to come on for fake precapture");
                }

                if (fake_precapture_turn_on_torch_id == null && (ae_state == null || ae_state == CaptureResult.CONTROL_AE_STATE_SEARCHING)) {
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.d(TAG, "fake precapture started after: " + (System.currentTimeMillis() - precapture_state_change_time_ms));
                    }
                    state = STATE_WAITING_FAKE_PRECAPTURE_DONE;
                    precapture_state_change_time_ms = System.currentTimeMillis();
                    ...
                    // just in case
                    // always log error, so we can look for it when manually testing with logging disabled
                    Logger.INSTANCE.e(TAG, "fake precapture start timeout");
                    count_precapture_timeout++;
                    state = STATE_WAITING_FAKE_PRECAPTURE_DONE;
                    precapture_state_change_time_ms = System.currentTimeMillis();
                    fake_precapture_turn_on_torch_id = null;
                ...
                Logger.INSTANCE.d(TAG, "waiting for fake precapture done...");
                if (MyDebug.LOG) {
                    if (ae_state != null)
                        Logger.INSTANCE.d(TAG, "CONTROL_AE_STATE = " + ae_state);
                    else
                        Logger.INSTANCE.d(TAG, "CONTROL_AE_STATE is null");
                    Logger.INSTANCE.d(TAG, "ready_for_capture? " + ready_for_capture);
                }
                ...
                if (ready_for_capture && (ae_state == null || ae_state != CaptureResult.CONTROL_AE_STATE_SEARCHING)) {
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.d(TAG, "fake precapture completed after: " + (System.currentTimeMillis() - precapture_state_change_time_ms));
                    }
                    state = STATE_NORMAL;
                    precapture_state_change_time_ms = -1;
                    takePictureAfterPrecapture();
                    ...
                    // always log error, so we can look for it when manually testing with logging disabled
                    Logger.INSTANCE.e(TAG, "fake precapture done timeout");
                    count_precapture_timeout++;
                    state = STATE_NORMAL;
                    precapture_state_change_time_ms = -1;
                    takePictureAfterPrecapture();
        ...
        private void handleContinuousFocusMove(CaptureResult result) {
            ...
            if (af_state != null && af_state == CaptureResult.CONTROL_AF_STATE_PASSIVE_SCAN && af_state != last_af_state) {
                /*if( MyDebug.LOG )
                    Logger.INSTANCE.d(TAG, "continuous focusing started");*/
                ...
                /*if( MyDebug.LOG )
                    Logger.INSTANCE.d(TAG, "continuous focusing stopped");*/
                if (continuous_focus_move_callback != null) {
        ...
        private void process(CaptureRequest request, CaptureResult result) {
            /*if( MyDebug.LOG )
            Logger.INSTANCE.d(TAG, "process, state: " + state);*/
            if (result.getFrameNumber() < last_process_frame_number) {
                /*if( MyDebug.LOG )
                    Logger.INSTANCE.d(TAG, "processAF discarded outdated frame " + result.getFrameNumber() + " vs " + last_process_frame_number);*/
                return;
            }
            /*long debug_time = 0;
            if( MyDebug.LOG ) {
            ...
            if (af_state != null && af_state != last_af_state) {
                /*if( MyDebug.LOG )
                    Logger.INSTANCE.d(TAG, "CONTROL_AF_STATE changed from " + last_af_state + " to " + af_state);*/
                last_af_state = af_state;
            }

            /*if( MyDebug.LOG ) {
                Logger.INSTANCE.d(TAG, "process() took: " + (System.currentTimeMillis() - debug_time));
            }*/
        }
        ...
        private void updateCachedCaptureResult(CaptureResult result) {
            if (modified_from_camera_settings) {
                ...
                /*if( MyDebug.LOG )
                    Logger.INSTANCE.d(TAG, "capture_result_iso: " + capture_result_iso);*/
                /*if( camera_settings.has_iso && Math.abs(camera_settings.iso - capture_result_iso) > 10 && previewBuilder != null ) {
                    ...
                    if( MyDebug.LOG ) {
                        Logger.INSTANCE.d(TAG, "ISO " + capture_result_iso + " different to requested ISO " + camera_settings.iso);
                        Logger.INSTANCE.d(TAG, "    requested ISO was: " + request.get(CaptureRequest.SENSOR_SENSITIVITY));
                        Logger.INSTANCE.d(TAG, "    requested AE mode was: " + request.get(CaptureRequest.CONTROL_AE_MODE));
                    }
                    try {
                        setRepeatingRequest();
                    }
                        ...
                        if( MyDebug.LOG ) {
                            Logger.INSTANCE.e(TAG, "failed to set repeating request after ISO hack");
                            Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                            Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                        }
                        e.printStackTrace();
            ...
            /*if( MyDebug.LOG ) {
                if( result.get(CaptureResult.SENSOR_EXPOSURE_TIME) != null ) {
                    ...
                    Logger.INSTANCE.d(TAG, "capture_result_exposure_time: " + capture_result_exposure_time);
                }
                if( result.get(CaptureResult.SENSOR_FRAME_DURATION) != null ) {
                    ...
                    Logger.INSTANCE.d(TAG, "capture_result_frame_duration: " + capture_result_frame_duration);
                }
            }*/
            /*if( modified_from_camera_settings ) {
                // see note above
            ...
            if (modified_from_camera_settings) {
                ...
                /*if( MyDebug.LOG ) {
                    Logger.INSTANCE.d(TAG, "capture_result_focus_distance: " + capture_result_focus_distance);
                    if( capture_result_focus_distance > 0.0f ) {
                        float real_focus_distance = 1.0f / capture_result_focus_distance;
                        Logger.INSTANCE.d(TAG, "real_focus_distance: " + real_focus_distance);
                    }
                }*/
            ...
            if (modified_from_camera_settings) {
                ...
                /*if( MyDebug.LOG ) {
                    Logger.INSTANCE.d(TAG, "capture_result_aperture: " + capture_result_aperture);
                }*/
            } else {
                capture_result_has_aperture = false;
            }
        ...
        private void handleRawCaptureResult(CaptureResult result) {
            ...
            if (test_wait_capture_result) {
                ...
                try {
                    Logger.INSTANCE.d(TAG, "test_wait_capture_result: waiting...");
        ...
        private void handleCaptureBurstInProgress(CaptureResult result) {
            Logger.INSTANCE.d(TAG, "handleCaptureBurstInProgress");
        ...
        private void handleCaptureCompleted(CaptureResult result) {
            Logger.INSTANCE.d(TAG, "capture request completed");
            test_capture_results++;
            modified_from_camera_settings = false;
            ...
            if (previewBuilder != null) {
                previewBuilder.set(CaptureRequest.CONTROL_AF_TRIGGER, CameraMetadata.CONTROL_AF_TRIGGER_CANCEL);
                Logger.INSTANCE.d(TAG, "### reset ae mode");
                String saved_flash_value = camera_settings.flash_value;
                if (use_fake_precapture_mode && fake_precapture_torch_performed) {
                    // same hack as in setFlashValue() - for fake precapture we need to turn off the torch mode that was set, but
                    // at least on Nexus 6, we need to turn to flash_off to turn off the torch!
                ...
                try {
                    ...
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.e(TAG, "failed to cancel autofocus after taking photo");
                        Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                        Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                    }
                    e.printStackTrace();
                ...
                try {
                    ...
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.e(TAG, "failed to start preview after taking photo");
                        Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                        Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                    }
                    e.printStackTrace();
            ...
            if (burst_type == BurstType.BURSTTYPE_FOCUS && previewBuilder != null) { // make sure camera wasn't released in the meantime
                Logger.INSTANCE.d(TAG, "focus bracketing complete, reset manual focus");
        ...
        private void callCheckImagesCompleted() {
            ...
            activity.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Logger.INSTANCE.d(TAG, "processCompleted UI thread call checkImagesCompleted()");
                    synchronized (background_camera_lock) {
                        done_all_captures = true;
                        Logger.INSTANCE.d(TAG, "done all captures");
                    }
                    checkImagesCompleted();
                }
            });
        ...
        private void processCompleted(CaptureRequest request, CaptureResult result) {
            /*if( MyDebug.LOG )
                Logger.INSTANCE.d(TAG, "processCompleted");*/
            ...
            if (push_repeating_request_when_torch_off && push_repeating_request_when_torch_off_id == request && previewBuilder != null) {
                Logger.INSTANCE.d(TAG, "received push_repeating_request_when_torch_off");
                Integer flash_state = result.get(CaptureResult.FLASH_STATE);
                if (MyDebug.LOG) {
                    if (flash_state != null)
                        Logger.INSTANCE.d(TAG, "flash_state: " + flash_state);
                    else
                        Logger.INSTANCE.d(TAG, "flash_state is null");
                }
                if (flash_state != null && flash_state == CaptureResult.FLASH_STATE_READY) {
                    ...
                    try {
                        ...
                        if (MyDebug.LOG) {
                            Logger.INSTANCE.e(TAG, "failed to set flash [from torch/flash off hack]");
                            Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                            Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                        }
                        e.printStackTrace();
            ...
            /*if( push_set_ae_lock && push_set_ae_lock_id == request && previewBuilder != null ) {
                if( MyDebug.LOG )
                    Logger.INSTANCE.d(TAG, "received push_set_ae_lock");
                ...
                try {
                    ...
                    if( MyDebug.LOG ) {
                        Logger.INSTANCE.e(TAG, "failed to set ae lock [from ae lock hack]");
                        Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                        Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                    }
                    e.printStackTrace();
            ...
            if (tag_type == RequestTagType.CAPTURE) {
                ...
                if (CameraController2.this.run_post_capture != null) {
                    Logger.INSTANCE.d(TAG, "take picture after delay for long manual exposure");
                    if (camera != null && hasCaptureSession()) { // make sure camera wasn't released in the meantime
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                try {
                                    ...
                                    if (MyDebug.LOG) {
                                        Logger.INSTANCE.e(TAG, "failed to take picture after delay for long manual exposure");
                                        Logger.INSTANCE.e(TAG, "reason: " + e.getReason());
                                        Logger.INSTANCE.e(TAG, "message: " + e.getMessage());
                                    }
                                    e.printStackTrace();
