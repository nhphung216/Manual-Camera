...
public class PanoramaProcessor {
    ...
    private void freeScripts() {
        Logger.INSTANCE.d(TAG, "freeScripts");
    ...
    private void initRenderscript() {
        Logger.INSTANCE.d(TAG, "initRenderscript");
    ...
    private Allocation reduceBitmapRS(ScriptC_pyramid_blending script, Allocation allocation) {
        Logger.INSTANCE.d(TAG, "reduceBitmapRS");
    ...
    private Bitmap reduceBitmap(Bitmap bitmap) {
        Logger.INSTANCE.d(TAG, "reduceBitmap");
        long time_s = 0;
        ...
        if (use_reduce_2d) {
            ...
            if( MyDebug.LOG )
                Logger.INSTANCE.d(TAG, "### time for reduceBitmapX: " + (System.currentTimeMillis() - time_s));
            ...
            */
            ...
            byte[] bitmap_argb;
            {
                ...
                Logger.INSTANCE.d(TAG, "### reduceBitmap: time after getPixels: " + (System.currentTimeMillis() - time_s));
                ...
                Logger.INSTANCE.d(TAG, "### reduceBitmap: time after converting int array to byte array: " + (System.currentTimeMillis() - time_s));
            }
            ...
            Logger.INSTANCE.d(TAG, "### time for reduceBitmapY: " + (System.currentTimeMillis() - time_s));
...

            {
                ...
                Logger.INSTANCE.d(TAG, "### reduceBitmap: time after converting byte array to int array: " + (System.currentTimeMillis() - time_s));
                reduced_bitmap.setPixels(pixels, 0, width / 2, 0, 0, width / 2, height / 2);
                Logger.INSTANCE.d(TAG, "### reduceBitmap: time after setPixels: " + (System.currentTimeMillis() - time_s));
            }
        }
        Logger.INSTANCE.d(TAG, "### time for reduceBitmap: " + (System.currentTimeMillis() - time_s));

        return reduced_bitmap;
    }

    private Allocation expandBitmapRS(ScriptC_pyramid_blending script, Allocation allocation) {
        Logger.INSTANCE.d(TAG, "expandBitmapRS");
        long time_s = 0;
        time_s = System.currentTimeMillis();
        ...
        Logger.INSTANCE.d(TAG, "### expandBitmap: time after creating expanded_allocation: " + (System.currentTimeMillis() - time_s));

        script.set_bitmap(allocation);
        script.forEach_expand(expanded_allocation, expanded_allocation);
        Logger.INSTANCE.d(TAG, "### expandBitmap: time after expand: " + (System.currentTimeMillis() - time_s));
        ...
        if (use_blur_2d) {
            ...
            Logger.INSTANCE.d(TAG, "### expandBitmap: time after creating result_allocation: " + (System.currentTimeMillis() - time_s));
            script.set_bitmap(expanded_allocation);
            script.forEach_blur(expanded_allocation, result_allocation);
            Logger.INSTANCE.d(TAG, "### expandBitmap: time after blur: " + (System.currentTimeMillis() - time_s));
            ...
            Logger.INSTANCE.d(TAG, "### expandBitmap: time after creating temp_allocation: " + (System.currentTimeMillis() - time_s));
            script.set_bitmap(expanded_allocation);
            script.forEach_blur1dX(expanded_allocation, temp_allocation);
            Logger.INSTANCE.d(TAG, "### expandBitmap: time after blur1dX: " + (System.currentTimeMillis() - time_s));
            ...
            Logger.INSTANCE.d(TAG, "### expandBitmap: time after blur1dY: " + (System.currentTimeMillis() - time_s));
    ...
    private Bitmap expandBitmap(Bitmap bitmap) {
        Logger.INSTANCE.d(TAG, "expandBitmap");
        long time_s = 0;
        time_s = System.currentTimeMillis();
        ...
        if( MyDebug.LOG )
            Logger.INSTANCE.d(TAG, "### expandBitmap: time after create expanded_bitmap: " + (System.currentTimeMillis() - time_s));
        ...
        if( MyDebug.LOG )
            Logger.INSTANCE.d(TAG, "### expandBitmap: time after create temp_bitmap: " + (System.currentTimeMillis() - time_s));
        ...
        */
        ...
        byte[] bitmap_argb;
        {
            int[] pixels = new int[width * height];
            bitmap.getPixels(pixels, 0, width, 0, 0, width, height);
            Logger.INSTANCE.d(TAG, "### expandBitmap: time after getPixels: " + (System.currentTimeMillis() - time_s));
            ...
            int_buffer.put(pixels);
            bitmap_argb = byte_buffer.array();
            Logger.INSTANCE.d(TAG, "### expandBitmap: time after converting int array to byte array: " + (System.currentTimeMillis() - time_s));
        }
        ...
        Bitmap result_bitmap = Bitmap.createBitmap(2 * width, 2 * height, Bitmap.Config.ARGB_8888);
        {
            ...
            int_buffer.get(pixels);
            Logger.INSTANCE.d(TAG, "### expandBitmap: time after converting byte array to int array: " + (System.currentTimeMillis() - time_s));
            result_bitmap.setPixels(pixels, 0, 2 * width, 0, 0, 2 * width, 2 * height);
            Logger.INSTANCE.d(TAG, "### expandBitmap: time after setPixels: " + (System.currentTimeMillis() - time_s));
        }
    ...
    private Allocation subtractBitmapRS(ScriptC_pyramid_blending script, Allocation allocation0, Allocation allocation1) {
        Logger.INSTANCE.d(TAG, "subtractBitmapRS");
        ...
        if (allocation1.getType().getX() != width || allocation1.getType().getY() != height) {
            Logger.INSTANCE.e(TAG, "allocations of different dimensions");
    ...
    private void addBitmapRS(ScriptC_pyramid_blending script, Allocation allocation0, Allocation allocation1) {
        Logger.INSTANCE.d(TAG, "addBitmapRS");
        int width = allocation0.getType().getX();
        int height = allocation0.getType().getY();
        if (allocation1.getType().getX() != width || allocation1.getType().getY() != height) {
            Logger.INSTANCE.e(TAG, "allocations of different dimensions");
    ...
    private void addBitmap(Bitmap bitmap0, float[] bitmap1) {
        Logger.INSTANCE.d(TAG, "addBitmap");
        int width = bitmap0.getWidth();
        int height = bitmap0.getHeight();
    ...
    private List<Allocation> createGaussianPyramidRS(ScriptC_pyramid_blending script, Bitmap bitmap, int n_levels) {
        Logger.INSTANCE.d(TAG, "createGaussianPyramidRS");
    ...
    private List<Bitmap> createGaussianPyramid(Bitmap bitmap, int n_levels) {
        Logger.INSTANCE.d(TAG, "createGaussianPyramid");
    ...
    private List<Allocation> createLaplacianPyramidRS(ScriptC_pyramid_blending script, Bitmap bitmap, int n_levels, String name) {
        Logger.INSTANCE.d(TAG, "createLaplacianPyramidRS");
        long time_s = 0;
        time_s = System.currentTimeMillis();

        List<Allocation> gaussianPyramid = createGaussianPyramidRS(script, bitmap, n_levels);
        Logger.INSTANCE.d(TAG, "### createLaplacianPyramid: time after createGaussianPyramid: " + (System.currentTimeMillis() - time_s));
        /*if( MyDebug.LOG )
        {
            // debug
        ...
        for (int i = 0; i < gaussianPyramid.size() - 1; i++) {
            Logger.INSTANCE.d(TAG, "createLaplacianPyramid: i = " + i);
            ...
            Logger.INSTANCE.d(TAG, "### createLaplacianPyramid: time after expandBitmap for level " + i + ": " + (System.currentTimeMillis() - time_s));
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "this_gauss: " + this_gauss.getType().getX() + " , " + this_gauss.getType().getY());
                Logger.INSTANCE.d(TAG, "next_gauss: " + next_gauss.getType().getX() + " , " + next_gauss.getType().getY());
                Logger.INSTANCE.d(TAG, "next_gauss_expanded: " + next_gauss_expanded.getType().getX() + " , " + next_gauss_expanded.getType().getY());
            }
            /*if( MyDebug.LOG )
            {
                // debug
            ...
            Logger.INSTANCE.d(TAG, "### createLaplacianPyramid: time after subtractBitmap for level " + i + ": " + (System.currentTimeMillis() - time_s));
            /*if( MyDebug.LOG )
            {
                // debug
            ...
            Logger.INSTANCE.d(TAG, "### createLaplacianPyramid: time after level " + i + ": " + (System.currentTimeMillis() - time_s));
        }
    ...
    private LaplacianPyramid createLaplacianPyramid(Bitmap bitmap, int n_levels, String name) {
        Logger.INSTANCE.d(TAG, "createLaplacianPyramid");
        long time_s = 0;
        time_s = System.currentTimeMillis();
    ...
    private Bitmap collapseLaplacianPyramidRS(ScriptC_pyramid_blending script, List<Allocation> pyramid) {
        Logger.INSTANCE.d(TAG, "collapseLaplacianPyramidRS");
    ...
    private Bitmap collapseLaplacianPyramid(LaplacianPyramid pyramid) {
        Logger.INSTANCE.d(TAG, "collapseLaplacianPyramid");
        ...
        for (int y = 0; y < height; y++) {
            if (false) {
                ...
                interpolated_best_path[y] = (int) (frac * width + 0.5f);
                    /*if( MyDebug.LOG ) {
                        Logger.INSTANCE.d(TAG, "    interpolated_best_path[" + y + "]: " + interpolated_best_path[y] + " (best_path_value " + best_path_value + ")");
                    }*/
            }
            //if( false )
            {
                ...
                if (best_path_y_index <= 0.5f) {
                    ...
                    best_path_value = (1.0f - alpha) * prev_best_path + alpha * next_best_path;
                        /*if( MyDebug.LOG ) {
                            ...
                            Logger.INSTANCE.d(TAG, "    prev_best_path: " + prev_best_path);
                            Logger.INSTANCE.d(TAG, "    next_best_path: " + next_best_path);
                        }*/
                }
                //interpolated_best_path[y] = (int)((best_path_value+1) * best_path_x_width + 0.5f);
                float alpha = best_path_value / (best_path_n_x - 1.0f);
            ...
            if (interpolated_best_path[y] - blend_width / 2 < 0) {
                Logger.INSTANCE.e(TAG, "    interpolated_best_path[" + y + "]: " + interpolated_best_path[y]);
                Logger.INSTANCE.e(TAG, "    blend_width: " + blend_width);
                Logger.INSTANCE.e(TAG, "    width: " + width);
    ...
    private void mergePyramidsRS(ScriptC_pyramid_blending script, List<Allocation> pyramid0, List<Allocation> pyramid1, int[] best_path, int best_path_n_x) {
        Logger.INSTANCE.d(TAG, "mergePyramidsRS");
        ...
        if (MyDebug.LOG) {
            for (int i = 0; i < best_path.length; i++)
                Logger.INSTANCE.d(TAG, "best_path[" + i + "]: " + best_path[i]);
        }
        ...
        for (int i = 0; i < pyramid0.size(); i++) {
            ...
            if (allocation1.getType().getX() != width || allocation1.getType().getY() != height) {
                ...
                Logger.INSTANCE.e(TAG, "allocations of different data types");
                throw new RuntimeException();
            }
            ...
            /*if( MyDebug.LOG ) {
                ...
                Logger.INSTANCE.d(TAG, "    blend_width: " + blend_width);
                Logger.INSTANCE.d(TAG, "    height: " + height);
                //Logger.INSTANCE.d(TAG, "    best_path_x_width: " + best_path_x_width);
                Logger.INSTANCE.d(TAG, "    best_path_y_scale: " + best_path_y_scale);
            }*/
    ...
    private void mergePyramids(LaplacianPyramid pyramid0, LaplacianPyramid pyramid1, int[] best_path, int best_path_n_x) {
        Logger.INSTANCE.d(TAG, "mergePyramids");
        ...
        for (int i = 0; i < pyramid0.diffs.size(); i++) {
            ...
            if (pyramid1.widths.get(i) != width || pyramid1.heights.get(i) != height) {
                Logger.INSTANCE.e(TAG, "pyramids of different dimensions");
                throw new RuntimeException();
            }
    ...
    private void saveAllocation(String name, Allocation allocation) {
        ...
        int width = allocation.getType().getX();
        int height = allocation.getType().getY();
        Logger.INSTANCE.d(TAG, "count: " + allocation.getType().getCount());
        Logger.INSTANCE.d(TAG, "byte size: " + allocation.getType().getElement().getBytesSize());
    ...
    private Bitmap blendPyramids(Bitmap lhs, Bitmap rhs) {
        ...
        if (!HDRProcessor.use_renderscript) {
            ...
            Logger.INSTANCE.d(TAG, "### blendPyramids: time after creating ScriptC_pyramid_blending: " + (System.currentTimeMillis() - time_s));
        }
        ...
        if (lhs.getWidth() != rhs.getWidth() || lhs.getHeight() != rhs.getHeight()) {
            Logger.INSTANCE.e(TAG, "lhs/rhs bitmaps of different dimensions");
            throw new RuntimeException();
        }

        final int blend_dimension = getBlendDimension();
        if (lhs.getWidth() % blend_dimension != 0) {
            Logger.INSTANCE.e(TAG, "bitmap width " + lhs.getWidth() + " not a multiple of " + blend_dimension);
            throw new RuntimeException();
        } else if (lhs.getHeight() % blend_dimension != 0) {
            Logger.INSTANCE.e(TAG, "bitmap height " + lhs.getHeight() + " not a multiple of " + blend_dimension);
            throw new RuntimeException();
        }
        ...
        if (find_best_path) {
            ...
            if (!HDRProcessor.use_renderscript) {
                ...
                Logger.INSTANCE.d(TAG, "### blendPyramids: time after creating allocations for best path: " + (System.currentTimeMillis() - time_s));
            ...
            for (int y = 0; y < best_path_n_y; y++) {
                ...
                for (int x = 0; x < best_path_n_x; x++) {
                    ...
                    Logger.INSTANCE.d(TAG, "    best_path error[" + x + "][" + y + "]: " + this_error);
                ...
                Logger.INSTANCE.d(TAG, "best_path [" + y + "]: " + best_path[y]);
            }
            ...
            Logger.INSTANCE.d(TAG, "### blendPyramids: time after finding best path: " + (System.currentTimeMillis() - time_s));
        }

        Bitmap merged_bitmap;
        if (!HDRProcessor.use_renderscript) {
            LaplacianPyramid lhs_pyramid = createLaplacianPyramid(lhs, blend_n_levels, "lhs");
            Logger.INSTANCE.d(TAG, "### blendPyramids: time after createLaplacianPyramid 1st call: " + (System.currentTimeMillis() - time_s));
            LaplacianPyramid rhs_pyramid = createLaplacianPyramid(rhs, blend_n_levels, "rhs");
            Logger.INSTANCE.d(TAG, "### blendPyramids: time after createLaplacianPyramid 2nd call: " + (System.currentTimeMillis() - time_s));
            ...
            Logger.INSTANCE.d(TAG, "### blendPyramids: time after mergePyramids: " + (System.currentTimeMillis() - time_s));
            /*{
                lhs_pyramid_rs = new ArrayList<>();
                for(int i=0;i<lhs_pyramid.diffs.size();i++) {
                    float [] difference_rgbf = lhs_pyramid.diffs.get(i);
            ...
            Logger.INSTANCE.d(TAG, "### blendPyramids: time after collapseLaplacianPyramid: " + (System.currentTimeMillis() - time_s));
        ...
        Logger.INSTANCE.d(TAG, "### blendPyramids: time taken: " + (System.currentTimeMillis() - time_s));
    ...
    private static void computeDistancesBetweenMatches(List<FeatureMatch> matches, int st_indx, int nd_indx, int feature_descriptor_radius, List<Bitmap> bitmaps, int[] pixels0, int[] pixels1) {
        ...
        for (int indx = st_indx; indx < nd_indx; indx++) {
            ...
            //if( MyDebug.LOG ) {
            //  Logger.INSTANCE.d(TAG, "match distance: ");
            //  Logger.INSTANCE.d(TAG, "    fg_corr: " + fg_corr);
            //  Logger.INSTANCE.d(TAG, "    fden: " + fden);
            //  Logger.INSTANCE.d(TAG, "    gden: " + gden);
            //  Logger.INSTANCE.d(TAG, "    f_recip: " + f_recip);
            //  Logger.INSTANCE.d(TAG, "    g_recip: " + g_recip);
            //}
    ...
    private AutoAlignmentByFeatureResult autoAlignmentByFeature(int width, int height, List<Bitmap> bitmaps, int debug_index) throws PanoramaProcessorException {
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "autoAlignmentByFeature");
            Logger.INSTANCE.d(TAG, "width: " + width);
            Logger.INSTANCE.d(TAG, "height: " + height);
        }
        long time_s = 0;
        time_s = System.currentTimeMillis();
        if (bitmaps.size() != 2) {
            Logger.INSTANCE.e(TAG, "must have 2 bitmaps");
            throw new PanoramaProcessorException(PanoramaProcessorException.INVALID_N_IMAGES);
        }

        /*if( MyDebug.LOG )
            Logger.INSTANCE.d(TAG, "convert to greyscale");
        ...
        if (!HDRProcessor.use_renderscript) {
            ...
            initRenderscript();
            Logger.INSTANCE.d(TAG, "### autoAlignmentByFeature: time after initRenderscript: " + (System.currentTimeMillis() - time_s));
            allocations = new Allocation[bitmaps.size()];
            for (int i = 0; i < bitmaps.size(); i++) {
                allocations[i] = Allocation.createFromBitmap(rs, bitmaps.get(i));
            }
            Logger.INSTANCE.d(TAG, "### autoAlignmentByFeature: time after creating allocations: " + (System.currentTimeMillis() - time_s));

            // create RenderScript
            if (featureDetectorScript == null) {
                featureDetectorScript = new ScriptC_feature_detector(rs);
            }
            Logger.INSTANCE.d(TAG, "### autoAlignmentByFeature: time after create featureDetectorScript: " + (System.currentTimeMillis() - time_s));
        }
        ...
        for (int i = 0; i < bitmaps.size(); i++) {
            Logger.INSTANCE.d(TAG, "detect features for image: " + i);
            ...
            if (!HDRProcessor.use_renderscript) {
                ...
                Logger.INSTANCE.d(TAG, "### autoAlignmentByFeature: time after ConvertToGreyscaleFunction: " + (System.currentTimeMillis() - time_s));

                Logger.INSTANCE.d(TAG, "compute derivatives");
                ...
                Logger.INSTANCE.d(TAG, "### autoAlignmentByFeature: time after ComputeDerivativesFunction: " + (System.currentTimeMillis() - time_s));

                gs_bitmap.recycle();

                Logger.INSTANCE.d(TAG, "call corner detector script for image: " + i);
                ...
                Logger.INSTANCE.d(TAG, "### autoAlignmentByFeature: time after CornerDetectorFunction: " + (System.currentTimeMillis() - time_s));
            ...
            */
            ...
            Logger.INSTANCE.d(TAG, "find local maxima for image: " + i);
            if (!HDRProcessor.use_renderscript) {
            } else {
                featureDetectorScript.set_bitmap(strength_allocation);
            }
            ...
            for (int cy = 0; cy < n_y_chunks; cy++) {
                Logger.INSTANCE.d(TAG, ">>> find corners, chunk " + cy + " / " + n_y_chunks);
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.d(TAG, "    start_y: " + start_y);
                    Logger.INSTANCE.d(TAG, "    stop_y: " + stop_y);
                }
                final int max_iter = 10;
                for (int count = 0; ; count++) {
                    Logger.INSTANCE.d(TAG, "### attempt " + count + " try threshold: " + threshold + " [ " + low_threshold + " : " + high_threshold + " ]");
                    ...
                    Logger.INSTANCE.d(TAG, "    " + points.size() + " points");
                    if (points.size() >= min_corners && points.size() <= max_corners) {
                        all_points.addAll(points);
                        break;
                    } else if (points.size() < min_corners) {
                        if (threshold <= min_threshold) {
                            Logger.INSTANCE.d(TAG, "    hit minimum threshold: " + threshold);
                            all_points.addAll(points);
                            break;
                        } else if (count + 1 == max_iter) {
                            Logger.INSTANCE.d(TAG, "    too few points but hit max iterations: " + points.size());
                            all_points.addAll(points);
                            //if( true )
                            ...
                            Logger.INSTANCE.d(TAG, "    reduced threshold to: " + threshold);
                        ...
                        Logger.INSTANCE.d(TAG, "    too many points but hit max iterations: " + points.size());
                        ...
                        Logger.INSTANCE.d(TAG, "    increased threshold to: " + threshold);
                    }
                }
            }
            points_arrays[i] = all_points.toArray(new Point[0]);

            Logger.INSTANCE.d(TAG, "### image: " + i + " has " + points_arrays[i].length + " points");
        ...
        Logger.INSTANCE.d(TAG, "### autoAlignmentByFeature: time after feature detection: " + (System.currentTimeMillis() - time_s));
        ...
        if (points_arrays[0].length < min_required_corners || points_arrays[1].length < min_required_corners) {
            Logger.INSTANCE.d(TAG, "too few points!");
            /*if( true )
                throw new RuntimeException();*/
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "max_match_dist_x: " + max_match_dist_x);
            Logger.INSTANCE.d(TAG, "max_match_dist_y: " + max_match_dist_y);
            Logger.INSTANCE.d(TAG, "max_match_dist2: " + max_match_dist2);
        }
        ...
        Logger.INSTANCE.d(TAG, "### possible matches: " + matches.size());
        Logger.INSTANCE.d(TAG, "### autoAlignmentByFeature: time after finding possible matches: " + (System.currentTimeMillis() - time_s));
        ...
        // compute distances between matches
        {
            ...
            if (use_smp) {
                ...
                Logger.INSTANCE.d(TAG, "n_threads: " + n_threads);
                ...
                for (int i = 0; i < n_threads; i++) {
                    ...
                    Logger.INSTANCE.d(TAG, "thread " + i + " from " + st_indx + " to " + nd_indx);
                ...
                try {
                    ...
                    Logger.INSTANCE.e(TAG, "ComputeDistancesBetweenMatchesThread threads interrupted");
                    e.printStackTrace();
        ...
        Logger.INSTANCE.d(TAG, "### autoAlignmentByFeature: time after computing match distances: " + (System.currentTimeMillis() - time_s));

        // sort
        Collections.sort(matches);
        Logger.INSTANCE.d(TAG, "### autoAlignmentByFeature: time after sorting matches: " + (System.currentTimeMillis() - time_s));
        if (MyDebug.LOG) {
            FeatureMatch best_match = matches.get(0);
            FeatureMatch worst_match = matches.get(matches.size() - 1);
            Logger.INSTANCE.d(TAG, "best match between " + best_match.index0 + " and " + best_match.index1 + " distance: " + best_match.distance);
            Logger.INSTANCE.d(TAG, "worst match between " + worst_match.index0 + " and " + worst_match.index1 + " distance: " + worst_match.distance);
        }
        ...
        for (int i = 0; i < matches.size(); i++) {
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "    match between " + match.index0 + " and " + match.index1 + " distance: " + match.distance);
            }
            ...
            for (int j = i + 1; j < matches.size() && !found; j++) {
                ...
                if (match.index0 == match2.index0) {
                    ...
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.d(TAG, "        next best match for index0 " + match.index0 + " is with " + match2.index1 + " distance: " + match2.distance + " , ratio: " + ratio);
                    }
                    ...
                    if (ratio + 1.0e-5 > 0.8f) {
                        if (MyDebug.LOG) {
                            Logger.INSTANCE.d(TAG, "        reject due to Lowe's test, ratio: " + ratio);
                        }
                        reject = true;
                    }
                }
        ...
        Logger.INSTANCE.d(TAG, "### autoAlignmentByFeature: time after initial matching: " + (System.currentTimeMillis() - time_s));
        Logger.INSTANCE.d(TAG, "### found: " + actual_matches.size() + " matches");
        Logger.INSTANCE.d(TAG, "### autoAlignmentByFeature: time after finding possible matches: " + (System.currentTimeMillis() - time_s));
        ...
        Logger.INSTANCE.d(TAG, "### resized to: " + actual_matches.size() + " actual matches");
        ...
        for (FeatureMatch match : actual_matches) {
            has_matched0[match.index0] = true;
            has_matched1[match.index1] = true;
            Logger.INSTANCE.d(TAG, "    actual match between " + match.index0 + " and " + match.index1 + " distance: " + match.distance);
        }
        Logger.INSTANCE.d(TAG, "### autoAlignmentByFeature: time after choosing best matches: " + (System.currentTimeMillis() - time_s));

        if (actual_matches.size() == 0) {
            Logger.INSTANCE.d(TAG, "no matches!");
            /*if( true )
                throw new RuntimeException();*/
        ...
        Logger.INSTANCE.d(TAG, "min_rotation_dist: " + min_rotation_dist);
        ...
        if (use_ransac) {
            ...
            Logger.INSTANCE.d(TAG, "max_inlier_dist: " + max_inlier_dist);
            ...
            for (int i = 0; i < actual_matches.size(); i++) {
...

                {
                    ...
                    if (inliers.size() > best_inliers.size()) {
                        ...
                        Logger.INSTANCE.d(TAG, "match " + i + " gives better translation model: " + inliers.size() + " inliers vs " + best_inliers.size());
                        ...
                        if (best_inliers.size() == actual_matches.size()) {
                            Logger.INSTANCE.d(TAG, "all matches are inliers");
                ...
                if (estimate_rotation) {
                    ...
                    for (int j = 0; j < i; j++) {
                        ...
                        /*if( MyDebug.LOG ) {
                            Logger.INSTANCE.d(TAG, "ransac: " + i + " , " + j + ": ");
                            Logger.INSTANCE.d(TAG, "    match 0: " + points_arrays[0][match.index0].x + " , " + points_arrays[0][match.index0].y);
                            Logger.INSTANCE.d(TAG, "    match 1: " + points_arrays[1][match.index1].x + " , " + points_arrays[1][match.index1].y);
                            Logger.INSTANCE.d(TAG, "    match2 0: " + points_arrays[0][match2.index0].x + " , " + points_arrays[0][match2.index0].y);
                            Logger.INSTANCE.d(TAG, "    match2 1: " + points_arrays[1][match2.index1].x + " , " + points_arrays[1][match2.index1].y);
                            Logger.INSTANCE.d(TAG, "    y_scale: " + y_scale);
                            Logger.INSTANCE.d(TAG, "    angle: " + angle);
                            Logger.INSTANCE.d(TAG, "    mag0: " + Math.sqrt(mag_sq0));
                            Logger.INSTANCE.d(TAG, "    mag1: " + Math.sqrt(mag_sq1));
                        }*/
                        ...
                        for (FeatureMatch other_match : actual_matches) {
                            ...
                            /*if( MyDebug.LOG ) {
                                if( other_match == match )
                                    Logger.INSTANCE.d(TAG, "    ransac on match: " + i + " , " + j + " : " + dx + " , " + dy);
                                else if( other_match == match2 )
                                    Logger.INSTANCE.d(TAG, "    ransac on match2: " + i + " , " + j + " : " + dx + " , " + dy);
                            }*/
                            float error2 = dx * dx + dy * dy;
                            if (error2 + 1.0e-5 <= max_inlier_dist2) {
                                inliers.add(other_match);
                        ...
                        if (inliers.size() > best_inliers.size() && inliers.size() >= 5) {
                            // found an improved model!
                            if (MyDebug.LOG) {
                                Logger.INSTANCE.d(TAG, "match " + i + " gives better rotation model: " + inliers.size() + " inliers vs " + best_inliers.size());
                                Logger.INSTANCE.d(TAG, "    c0_x: " + c0_x + " , c0_y: " + c0_y);
                                Logger.INSTANCE.d(TAG, "    c1_x: " + c1_x + " , c1_y: " + c1_y);
                                Logger.INSTANCE.d(TAG, "    dx0: " + dx0 + " , dy0: " + dy0);
                                Logger.INSTANCE.d(TAG, "    dx1: " + dx1 + " , dy1: " + dy1);
                                Logger.INSTANCE.d(TAG, "    rotate by " + angle + " about: " + c0_x + " , " + c0_y);
                                Logger.INSTANCE.d(TAG, "    y scale by " + y_scale);
                                Logger.INSTANCE.d(TAG, "    translate by: " + (c1_x - c0_x) + " , " + (c1_y - c0_y));
                            }
                            ransac_matches.clear();
                            ransac_matches.add(match);
            ...
            Logger.INSTANCE.d(TAG, "### autoAlignmentByFeature: time after RANSAC: " + (System.currentTimeMillis() - time_s));
            if (MyDebug.LOG) {
                for (FeatureMatch match : actual_matches) {
                    Logger.INSTANCE.d(TAG, "    after ransac: actual match between " + match.index0 + " and " + match.index1 + " distance: " + match.distance);
                }
            }
        }
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "centres[0]: " + centres[0].x + " , " + centres[0].y);
            Logger.INSTANCE.d(TAG, "centres[1]: " + centres[1].x + " , " + centres[1].y);
        }
        ...
        if (estimate_rotation && use_rotation) {
            ...
            /*if( estimate_y_scale && use_y_scale ) {
                ...
                for(FeatureMatch match : actual_matches) {
                    ...
                    if( Math.abs(d0_y) > min_rotation_dist && Math.abs(d1_y) > min_rotation_dist ) {
                        ...
                        n_y_scale++;
                        if( MyDebug.LOG )
                            Logger.INSTANCE.d(TAG, "    match has scale: " + this_y_scale);
                    }
                }
                if( n_y_scale > 0 ) {
            ...
            for (FeatureMatch match : actual_matches) {
                ...
                if (angle < -Math.PI)
                    ...
                    angle -= 2.0f * Math.PI;
                Logger.INSTANCE.d(TAG, "    match has angle: " + angle);
                angle_sum += angle;
                n_angles++;
            }
            if (n_angles > 0) {
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "offset_x before rotation: " + offset_x);
                Logger.INSTANCE.d(TAG, "offset_y before rotation: " + offset_y);
                Logger.INSTANCE.d(TAG, "rotated_centre: " + rotated_centre_x + " , " + rotated_centre_y);
            }
            offset_x += centres[0].x - rotated_centre_x;
            offset_y += centres[0].y - rotated_centre_y;

        }
        Logger.INSTANCE.d(TAG, "### autoAlignmentByFeature: time after computing transformation: " + (System.currentTimeMillis() - time_s));
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "offset_x: " + offset_x);
            Logger.INSTANCE.d(TAG, "offset_y: " + offset_y);
            Logger.INSTANCE.d(TAG, "rotation: " + rotation);
            Logger.INSTANCE.d(TAG, "y_scale: " + y_scale);

            Logger.INSTANCE.d(TAG, "ransac matches are:");
            for (FeatureMatch match : ransac_matches) {
                ...
                Logger.INSTANCE.d(TAG, "    index : " + match.index0 + " to " + match.index1);
                Logger.INSTANCE.d(TAG, "        coords " + x0 + " , " + y0 + " to " + x1 + " , " + y1);
                Logger.INSTANCE.d(TAG, "        distance: " + match.distance);
            }
        }
        ...
        if (false && MyDebug.LOG) {
            ...
            for (int i = 0; i < 2; i++) {
                for (int j = 0; j < points_arrays[i].length; j++) {
                    ...
                    if (i == 0) {
                        /*if( MyDebug.LOG )
                            Logger.INSTANCE.d(TAG, "### has_matched0[" + j + "]: " + has_matched0[j]);*/
                        was_matched = has_matched0[j];
                    } else {
                        /*if( MyDebug.LOG )
                            Logger.INSTANCE.d(TAG, "### has_matched1[" + j + "]: " + has_matched1[j]);*/
        ...
        Logger.INSTANCE.d(TAG, "### autoAlignmentByFeature: total time: " + (System.currentTimeMillis() - time_s));
    ...
    private void renderPanoramaImage(final int i, final int n_bitmaps, final Rect src_rect_workspace, final Rect dst_rect_workspace,
        ...
        if (MyDebug.LOG) {
            //Logger.INSTANCE.d(TAG, "    alpha: " + alpha + " ( " + Math.toDegrees(alpha) + " degrees )");
            Logger.INSTANCE.d(TAG, "    align_x: " + align_x);
            Logger.INSTANCE.d(TAG, "    align_y: " + align_y);
            Logger.INSTANCE.d(TAG, "    dst_offset_x: " + dst_offset_x);
            Logger.INSTANCE.d(TAG, "    shift_stop_x: " + shift_stop_x);
        }

        Logger.INSTANCE.d(TAG, "### time before projection for " + i + "th bitmap: " + (System.currentTimeMillis() - time_s));
        ...
        Logger.INSTANCE.d(TAG, "### time after projection for " + i + "th bitmap: " + (System.currentTimeMillis() - time_s));

        if (i > 0 && blend_hwidth > 0) {
            Logger.INSTANCE.d(TAG, "### time before blending for " + i + "th bitmap: " + (System.currentTimeMillis() - time_s));
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "blend_dimension: " + blend_dimension);
                Logger.INSTANCE.d(TAG, "blend_hwidth: " + blend_hwidth);
                Logger.INSTANCE.d(TAG, "bitmap_height: " + bitmap_height);
                Logger.INSTANCE.d(TAG, "blend_width: " + blend_width);
                Logger.INSTANCE.d(TAG, "blend_height: " + blend_height);
            }
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "lhs dimensions: " + lhs.getWidth() + " x " + lhs.getHeight());
                Logger.INSTANCE.d(TAG, "rhs dimensions: " + rhs.getWidth() + " x " + rhs.getHeight());
            }
            ...
            */
            ...
            Logger.INSTANCE.d(TAG, "### time after blending for " + i + "th bitmap: " + (System.currentTimeMillis() - time_s));
        }
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "    offset_x: " + offset_x);
            Logger.INSTANCE.d(TAG, "    dst_offset_x: " + dst_offset_x);
            Logger.INSTANCE.d(TAG, "    start_x: " + start_x);
            Logger.INSTANCE.d(TAG, "    stop_x: " + stop_x);
        }

        // draw rest of this image
        Logger.INSTANCE.d(TAG, "### time before drawing non-blended region for " + i + "th bitmap: " + (System.currentTimeMillis() - time_s));
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "    src_rect_workspace: " + src_rect_workspace);
            Logger.INSTANCE.d(TAG, "    dst_rect_workspace: " + dst_rect_workspace);
        }
        canvas.drawBitmap(projected_bitmap, src_rect_workspace, dst_rect_workspace, p);
        Logger.INSTANCE.d(TAG, "### time after drawing non-blended region for " + i + "th bitmap: " + (System.currentTimeMillis() - time_s));
        ...
        for(int x=start_x;x<stop_x;x++) {
            ...
            if( i > 0 && x < blend_hwidth ) {
                ...
                //if( MyDebug.LOG )
                //Logger.INSTANCE.d(TAG, "    left hand blend_alpha: " + blend_alpha);
            }
                ...
                blend_alpha = (int)(255.0f*frac);
                //if( MyDebug.LOG )
                //Logger.INSTANCE.d(TAG, "    right hand blend_alpha: " + blend_alpha);
            }
        ...
        */
        ...
        if( MyDebug.LOG ) {
            Logger.INSTANCE.d(TAG, "    src top-left: " + src_x0 + " , " + src_y0);
            Logger.INSTANCE.d(TAG, "    src bottom-left: " + src_x1 + " , " + src_y1);
            Logger.INSTANCE.d(TAG, "    src top-right: " + src_x2 + " , " + src_y2);
            Logger.INSTANCE.d(TAG, "    src bottom-right: " + src_x3 + " , " + src_y3);
            Logger.INSTANCE.d(TAG, "    dst top-left: " + dst_x0 + " , " + dst_y0);
            Logger.INSTANCE.d(TAG, "    dst bottom-left: " + dst_x1 + " , " + dst_y1);
            Logger.INSTANCE.d(TAG, "    dst top-right: " + dst_x2 + " , " + dst_y2);
            Logger.INSTANCE.d(TAG, "    dst bottom-right: " + dst_x3 + " , " + dst_y3);
        }
        ...
        if( MyDebug.LOG )
            Logger.INSTANCE.d(TAG, "matrix: " + matrix);
    ...
    private float adjustExposuresLocal(List<Bitmap> bitmaps, int bitmap_width, int bitmap_height, int slice_width, long time_s) {
        ...
        Logger.INSTANCE.d(TAG, "### time before computing brightnesses: " + (System.currentTimeMillis() - time_s));
        ...
        for (int i = 0; i < bitmaps.size() - 1; i++) {
            ...
            Logger.INSTANCE.d(TAG, "### time before cropping bitmaps: " + (System.currentTimeMillis() - time_s));
            ...
            Logger.INSTANCE.d(TAG, "### time after cropping bitmaps: " + (System.currentTimeMillis() - time_s));
            // debug
            /*if( MyDebug.LOG )
            {
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "compare brightnesses from images " + i + " to " + (i + 1) + ":");
                Logger.INSTANCE.d(TAG, "    left median: " + histogramInfo_l.median_brightness);
                Logger.INSTANCE.d(TAG, "    right median: " + histogramInfo_r.median_brightness);
                Logger.INSTANCE.d(TAG, "    brightness_scale: " + brightness_scale);
                Logger.INSTANCE.d(TAG, "    current_relative_brightness: " + current_relative_brightness);
            }
            relative_brightness.add(current_relative_brightness);
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "min_relative_brightness: " + min_relative_brightness);
            Logger.INSTANCE.d(TAG, "max_relative_brightness: " + max_relative_brightness);
            Logger.INSTANCE.d(TAG, "ratio of max to min relative brightness: " + ratio_brightnesses);
        }
        ...
        if( MyDebug.LOG )
            Logger.INSTANCE.d(TAG, "avg_relative_brightness: " + avg_relative_brightness);
        */

        Logger.INSTANCE.d(TAG, "### time after computing brightnesses: " + (System.currentTimeMillis() - time_s));
        ...
        for (int i = 0; i < bitmaps.size(); i++) {
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "image " + i + " has median brightness " + histogramInfo.median_brightness);
                Logger.INSTANCE.d(TAG, "    and equalised_brightness " + equalised_brightness);
            }
        }
        mean_median_brightness /= bitmaps.size();
        mean_equalised_brightness /= bitmaps.size();
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "mean_median_brightness: " + mean_median_brightness);
            Logger.INSTANCE.d(TAG, "mean_equalised_brightness: " + mean_equalised_brightness);
        }

        float avg_relative_brightness = mean_median_brightness / Math.max(mean_equalised_brightness, 1.0f);

        Logger.INSTANCE.d(TAG, "### time after computing global histograms: " + (System.currentTimeMillis() - time_s));

        float min_preferred_scale = 1000.0f, max_preferred_scale = 0.0f;
        for (int i = 0; i < bitmaps.size(); i++) {
            Logger.INSTANCE.d(TAG, "    adjust exposure for image: " + i);
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "    image " + i + " has initial brightness_target: " + brightness_target);
                Logger.INSTANCE.d(TAG, "    median_brightness: " + histogramInfo.median_brightness);
                Logger.INSTANCE.d(TAG, "    relative_brightness: " + relative_brightness.get(i));
                Logger.INSTANCE.d(TAG, "    avg_relative_brightness: " + avg_relative_brightness);
            }
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "    brightness_target: " + brightness_target);
                Logger.INSTANCE.d(TAG, "    preferred brightness scale: " + brightness_target / (float) histogramInfo.median_brightness);
                Logger.INSTANCE.d(TAG, "    this_brightness_target: " + this_brightness_target);
                Logger.INSTANCE.d(TAG, "    actual brightness scale: " + this_brightness_target / (float) histogramInfo.median_brightness);
            }

            hdrProcessor.brightenImage(bitmap, histogramInfo.median_brightness, histogramInfo.max_brightness, this_brightness_target);
        }
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "min_preferred_scale: " + min_preferred_scale);
            Logger.INSTANCE.d(TAG, "max_preferred_scale: " + max_preferred_scale);
            Logger.INSTANCE.d(TAG, "### time after adjusting brightnesses: " + (System.currentTimeMillis() - time_s));
        }
    ...
    /*private void adjustExposures(List<Bitmap> bitmaps, long time_s) {
        ...
        for(int i=0;i<bitmaps.size();i++) {
            ...
            //if( MyDebug.LOG )
            //    Logger.INSTANCE.d(TAG, "    local_mean_brightness: " + local_mean_brightness);
    ...
    private void computePanoramaTransforms(List<Matrix> cumulative_transforms, List<Integer> align_x_values, List<Integer> dst_offset_x_values,
        ...
        for (int i = 0; i < bitmaps.size(); i++) {
            Logger.INSTANCE.d(TAG, "process bitmap: " + i);
            ...
            if (use_auto_align && i > 0) {
                ...
                if (MyDebug.LOG) {
                    ...
                    Logger.INSTANCE.d(TAG, "    align_x+offset_x+slice_width-align_hwidth: " + (align_x + offset_x + slice_width - align_hwidth));
                    Logger.INSTANCE.d(TAG, "    bitmap(i-1) width: " + bitmaps.get(i - 1).getWidth());
                }
                ...
                if (use_align_by_feature) {
                    ...
                    if (MyDebug.LOG) {
                        Logger.INSTANCE.d(TAG, "downscale by: " + align_downsample);
                        Logger.INSTANCE.d(TAG, "### time before downscaling creating alignment bitmaps for " + i + "th bitmap: " + (System.currentTimeMillis() - time_s));
                    }
                    // snap to power of 2
                    for (int k = 0, power = 1; k <= 4; k++, power *= 2) {
                        ...
                        if (ratio >= 0.95f && ratio <= 1.05f) {
                            ...
                            Logger.INSTANCE.d(TAG, "snapped downscale to: " + align_downsample);
                            break;
                        }
                    }
                }
                ...
                Logger.INSTANCE.d(TAG, "### time before creating alignment bitmaps for " + i + "th bitmap: " + (System.currentTimeMillis() - time_s));
                ...
                Logger.INSTANCE.d(TAG, "### time after creating alignment bitmaps for " + i + "th bitmap: " + (System.currentTimeMillis() - time_s));
                ...
                /*if( use_align_by_feature ) {
                    ...
                    if( MyDebug.LOG )
                        Logger.INSTANCE.d(TAG, "### time after downscaling creating alignment bitmaps for " + i + "th bitmap: " + (System.currentTimeMillis() - time_s));
                }*/
                ...
                float y_scale = 1.0f;
                Logger.INSTANCE.d(TAG, "### time before auto-alignment for " + i + "th bitmap: " + (System.currentTimeMillis() - time_s));
                if (use_align_by_feature) {
                ...
                Logger.INSTANCE.d(TAG, "### time after auto-alignment for " + i + "th bitmap: " + (System.currentTimeMillis() - time_s));
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.d(TAG, "    this_align_x: " + this_align_x);
                    Logger.INSTANCE.d(TAG, "    this_align_y: " + this_align_y);
                }
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.d(TAG, "    align_x is now: " + align_x);
                    Logger.INSTANCE.d(TAG, "    align_y is now: " + align_y);
                }
            }
            ...
            Logger.INSTANCE.d(TAG, "    dst_offset_x is now: " + dst_offset_x);

            Logger.INSTANCE.d(TAG, "### time after processing " + i + "th bitmap: " + (System.currentTimeMillis() - time_s));
        }
    }
    ...
    private void adjustPanoramaTransforms(List<Bitmap> bitmaps, List<Matrix> cumulative_transforms,
        ...
        for (int i = 0; i < bitmaps.size(); i++) {
            ...
            Logger.INSTANCE.d(TAG, "bitmap " + i + " has rotation " + rotation + " degrees");
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "min_rotation: " + min_rotation + " degrees");
            Logger.INSTANCE.d(TAG, "max_rotation: " + max_rotation + " degrees");
            //Logger.INSTANCE.d(TAG, "mid_rotation: " + mid_rotation + " degrees");
        }
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "x0: " + x0);
            Logger.INSTANCE.d(TAG, "y0: " + y0);
            Logger.INSTANCE.d(TAG, "x1: " + x1);
            Logger.INSTANCE.d(TAG, "y1: " + y1);
            Logger.INSTANCE.d(TAG, "dx: " + dx);
            Logger.INSTANCE.d(TAG, "dy: " + dy);
            Logger.INSTANCE.d(TAG, "mid_rotation: " + mid_rotation + " degrees");
        }
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "limited mid_rotation to: " + mid_rotation + " degrees");
        }
        ...
        for (int i = 0; i < bitmaps.size(); i++) {
            ...
            cumulative_transforms.get(i).postRotate(mid_rotation, centre_x, centre_y);
            {
                cumulative_transforms.get(i).getValues(values);
                float rotation = (float) Math.toDegrees(Math.atan2(values[Matrix.MSKEW_X], values[Matrix.MSCALE_X]));
                Logger.INSTANCE.d(TAG, "bitmap " + i + " now has rotation " + rotation + " degrees");
            }
        }
    }
    ...
    private void renderPanorama(List<Bitmap> bitmaps, int bitmap_width, int bitmap_height,
        ...
        for (int i = 0; i < bitmaps.size(); i++) {
            Logger.INSTANCE.d(TAG, "render bitmap: " + i);
            Bitmap bitmap = bitmaps.get(i);
...

            {
                ...
                if (align_x != 0) {
                    ...
                    //if( MyDebug.LOG )
                    //Logger.INSTANCE.d(TAG, "centre_shift_x: " + centre_shift_x);
                    //if( MyDebug.LOG )
                    //Logger.INSTANCE.d(TAG, "    align_x: " + align_x);
                    centre_shift_x += bake_trans_x;
                    //if( MyDebug.LOG )
                    //Logger.INSTANCE.d(TAG, "new centre_shift_x: " + centre_shift_x);
            ...
            Logger.INSTANCE.d(TAG, "### time after rendering " + i + "th bitmap: " + (System.currentTimeMillis() - time_s));
        }
    }
    ...
    public Bitmap panorama(List<Bitmap> bitmaps, float panorama_pics_per_screen, float camera_angle_y, final boolean crop) throws PanoramaProcessorException {
        if (MyDebug.LOG) {
            ...
            Logger.INSTANCE.d(TAG, "camera_angle_y: " + camera_angle_y);
        }
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "camera_angle_y: " + camera_angle_y);
            Logger.INSTANCE.d(TAG, "camera_angle: " + camera_angle);
        }
        ...
        if( MyDebug.LOG ) {
            Logger.INSTANCE.d(TAG, "h: " + h);
            Logger.INSTANCE.d(TAG, "max_offset_error_x: " + max_offset_error_x);
            Logger.INSTANCE.d(TAG, "max_offset_error_y: " + max_offset_error_y);
        }
        */
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "    blend_hwidth: " + blend_hwidth);
            Logger.INSTANCE.d(TAG, "    align_hwidth: " + align_hwidth);
        }
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "original panorama_width: " + panorama_width);
        }

        adjustPanoramaTransforms(bitmaps, cumulative_transforms, panorama_width, slice_width, bitmap_width, bitmap_height);
        Logger.INSTANCE.d(TAG, "### time after adjusting transforms: " + (System.currentTimeMillis() - time_s));
        ...
        if (crop) {
            ...
            for (int i = 0; i < bitmaps.size(); i++) {
                ...
                if (MyDebug.LOG) {
                    Logger.INSTANCE.d(TAG, "i: " + i);
                    Logger.INSTANCE.d(TAG, "    points[0]: " + points[0]);
                    Logger.INSTANCE.d(TAG, "    points[1]: " + points[1]);
                    Logger.INSTANCE.d(TAG, "    points[2]: " + points[2]);
                    Logger.INSTANCE.d(TAG, "    points[3]: " + points[3]);
                    Logger.INSTANCE.d(TAG, "    points[4]: " + points[4]);
                    Logger.INSTANCE.d(TAG, "    points[5]: " + points[5]);
                    Logger.INSTANCE.d(TAG, "    points[6]: " + points[6]);
                    Logger.INSTANCE.d(TAG, "    points[7]: " + points[7]);
                }
                if (i == 0) {
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "crop_x0: " + crop_x0);
                Logger.INSTANCE.d(TAG, "crop_x1: " + crop_x1);
                Logger.INSTANCE.d(TAG, "panorama_width: " + panorama_width);
            }
            /*if( crop_x0 > 0 ) {
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "crop_y0: " + crop_y0);
                Logger.INSTANCE.d(TAG, "crop_y1: " + crop_y1);
                Logger.INSTANCE.d(TAG, "panorama_height: " + panorama_height);
            }
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "theta: " + theta);
                Logger.INSTANCE.d(TAG, "yscale: " + yscale);
            }
            //yscale = 1.0f;
        ...
        Logger.INSTANCE.d(TAG, "### time before rendering bitmaps: " + (System.currentTimeMillis() - time_s));
        ...
        Logger.INSTANCE.d(TAG, "### time after rendering bitmaps: " + (System.currentTimeMillis() - time_s));
        ...
        if (ratio_brightnesses >= 3.0f) {
            Logger.INSTANCE.d(TAG, "apply contrast enhancement, ratio_brightnesses: " + ratio_brightnesses);
            ...
            if (!HDRProcessor.use_renderscript) {
                ...
                Logger.INSTANCE.d(TAG, "### time after adjustHistogram: " + (System.currentTimeMillis() - time_s));
            } else {
                Allocation allocation = Allocation.createFromBitmap(rs, panorama);
                Logger.INSTANCE.d(TAG, "### time after creating allocation_out: " + (System.currentTimeMillis() - time_s));
                ...
                allocation.destroy();
                Logger.INSTANCE.d(TAG, "### time after copying to bitmap: " + (System.currentTimeMillis() - time_s));
            }
        }

        Logger.INSTANCE.d(TAG, "panorama complete!");

        freeScripts();

        Logger.INSTANCE.d(TAG, "### time taken for panorama: " + (System.currentTimeMillis() - time_s));
