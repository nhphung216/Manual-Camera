...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED =
            "com.ssolstice.camera.manual.Remotecontrol.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED =
            "com.ssolstice.camera.manual.Remotecontrol.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED =
            "com.ssolstice.camera.manual.Remotecontrol.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE =
            "com.ssolstice.camera.manual.Remotecontrol.ACTION_DATA_AVAILABLE";
    public final static String ACTION_REMOTE_COMMAND =
            "com.ssolstice.camera.manual.Remotecontrol.COMMAND";
    public final static String ACTION_SENSOR_VALUE =
            "com.ssolstice.camera.manual.Remotecontrol.SENSOR";
    public final static String SENSOR_TEMPERATURE =
            "com.ssolstice.camera.manual.Remotecontrol.TEMPERATURE";
    public final static String SENSOR_DEPTH =
            "com.ssolstice.camera.manual.Remotecontrol.DEPTH";
    public final static String EXTRA_DATA =
            "com.ssolstice.camera.manual.Remotecontrol.EXTRA_DATA";
