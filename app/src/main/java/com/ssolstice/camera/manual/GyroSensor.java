...
public class GyroSensor implements SensorEventListener {
    ...
    GyroSensor(Context context) {
        ...
        if (MyDebug.LOG) {
            Logger.INSTANCE.d(TAG, "GyroSensor");
            if (mSensor == null)
                Logger.INSTANCE.d(TAG, "gyroscope not available");
            else if (mSensorAccel == null)
                Logger.INSTANCE.d(TAG, "accelerometer not available");
        }
        setToIdentity();
    }
     ...
     */
    void enableSensors() {
        Logger.INSTANCE.d(TAG, "enableSensors");
    ...
    void disableSensors() {
        Logger.INSTANCE.d(TAG, "disableSensors");
        mSensorManager.unregisterListener(this);
    }

    void startRecording() {
        Logger.INSTANCE.d(TAG, "startRecording");
        is_recording = true;
        timestamp = 0;
        setToIdentity();
    }
    ...
    void stopRecording() {
        if (is_recording) {
            Logger.INSTANCE.d(TAG, "stopRecording");
            is_recording = false;
            timestamp = 0;
        }
    }
    ...
    private void adjustGyroForAccel() {
        ...
        /*if( MyDebug.LOG ) {
            Logger.INSTANCE.d(TAG, "adjustGyroForAccel:");
            Logger.INSTANCE.d(TAG, "### currentRotationMatrix row 0: " + currentRotationMatrix[0] + " , " + currentRotationMatrix[1] + " , " + currentRotationMatrix[2]);
            Logger.INSTANCE.d(TAG, "### currentRotationMatrix row 1: " + currentRotationMatrix[3] + " , " + currentRotationMatrix[4] + " , " + currentRotationMatrix[5]);
            Logger.INSTANCE.d(TAG, "### currentRotationMatrix row 2: " + currentRotationMatrix[6] + " , " + currentRotationMatrix[7] + " , " + currentRotationMatrix[8]);
            Logger.INSTANCE.d(TAG, "### initAccelVector: " + initAccelVector[0] + " , " + initAccelVector[1] + " , " + initAccelVector[2]);
            Logger.INSTANCE.d(TAG, "### accelVector: " + accelVector[0] + " , " + accelVector[1] + " , " + accelVector[2]);
            Logger.INSTANCE.d(TAG, "### tempVector: " + tempVector[0] + " , " + tempVector[1] + " , " + tempVector[2]);
            Logger.INSTANCE.d(TAG, "### cos_angle: " + cos_angle);
        }*/
        ...
        */
        ...
        /*if( MyDebug.LOG ) {
            ...
            Logger.INSTANCE.d(TAG, "### tempMatrix row 0: " + tempMatrix[0] + " , " + tempMatrix[1] + " , " + tempMatrix[2]);
            Logger.INSTANCE.d(TAG, "### tempMatrix row 1: " + tempMatrix[3] + " , " + tempMatrix[4] + " , " + tempMatrix[5]);
            Logger.INSTANCE.d(TAG, "### tempMatrix row 2: " + tempMatrix[6] + " , " + tempMatrix[7] + " , " + tempMatrix[8]);
            Logger.INSTANCE.d(TAG, "### rotated tempVector: " + tempVector[0] + " , " + tempVector[1] + " , " + tempVector[2]);
        }*/
        ...
        /*if( MyDebug.LOG ) {
            ...
            Logger.INSTANCE.d(TAG, "### new currentRotationMatrix row 0: " + temp2Matrix[0] + " , " + temp2Matrix[1] + " , " + temp2Matrix[2]);
            Logger.INSTANCE.d(TAG, "### new currentRotationMatrix row 1: " + temp2Matrix[3] + " , " + temp2Matrix[4] + " , " + temp2Matrix[5]);
            Logger.INSTANCE.d(TAG, "### new currentRotationMatrix row 2: " + temp2Matrix[6] + " , " + temp2Matrix[7] + " , " + temp2Matrix[8]);
            Logger.INSTANCE.d(TAG, "### new tempVector: " + tempVector[0] + " , " + tempVector[1] + " , " + tempVector[2]);
        }*/
    }
    ...
    public void onSensorChanged(SensorEvent event) {
        /*if( MyDebug.LOG )
            Logger.INSTANCE.d(TAG, "onSensorChanged: " + event);*/
        if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            if (timestamp != 0) {
                ...
                /*if( MyDebug.LOG ) {
                    Logger.INSTANCE.d(TAG, "### values: " + event.values[0] + " , " + event.values[1] + " , " + event.values[2]);
                    Logger.INSTANCE.d(TAG, "smoothed values: " + gyroVector[0] + " , " + gyroVector[1] + " , " + gyroVector[2]);
                }*/
                ...
                /*if( MyDebug.LOG ) {
                    ...
                    Logger.INSTANCE.d(TAG, "### gyro vector: " + tempVector[0] + " , " + tempVector[1] + " , " + tempVector[2]);
                }*/
            ...
            if (MyDebug.LOG) {
                Logger.INSTANCE.d(TAG, "### values: " + event.values[0] + " , " + event.values[1] + " , " + event.values[2] + " , " + event.values[3]);
                Logger.INSTANCE.d(TAG, "    " + currentRotationMatrix[0] + " , " + currentRotationMatrix[1] + " , " + currentRotationMatrix[2]);
                Logger.INSTANCE.d(TAG, "    " + currentRotationMatrix[3] + " , " + currentRotationMatrix[4] + " , " + currentRotationMatrix[5]);
                Logger.INSTANCE.d(TAG, "    " + currentRotationMatrix[6] + " , " + currentRotationMatrix[7] + " , " + currentRotationMatrix[8]);
            }
        }
        ...
        if (hasTarget) {
            ...
            for (int indx = 0; indx < targetVectors.size(); indx++) {
                ...
                transformVector(tempVector, currentRotationMatrix, inVector);
                /*if( MyDebug.LOG ) {
                    Logger.INSTANCE.d(TAG, "### transformed vector up: " + tempVector[0] + " , " + tempVector[1] + " , " + tempVector[2]);
                }*/
                ...
                /*if( MyDebug.LOG ) {
                    Logger.INSTANCE.d(TAG, "    u: " + ux + " , " + uy + " , " + uz);
                    Logger.INSTANCE.d(TAG, "    p_u: " + p_ux + " , " + p_uy + " , " + p_uz);
                }*/
                double p_u_mag = Math.sqrt(p_ux * p_ux + p_uy * p_uy + p_uz * p_uz);
                if (p_u_mag > 1.0e-5) {
                    /*if( MyDebug.LOG ) {
                        Logger.INSTANCE.d(TAG, "    p_u norm: " + p_ux/p_u_mag + " , " + p_uy/p_u_mag + " , " + p_uz/p_u_mag);
                    }*/
                    // normalise p_u
                    p_ux /= p_u_mag;
                    ...
                    float cz = p_ux;
                    /*if( MyDebug.LOG ) {
                        Logger.INSTANCE.d(TAG, "    c: " + cx + " , " + cy + " , " + cz);
                    }*/
                ...
                if (is_upright == 0) {
                    /*if( MyDebug.LOG )
                        Logger.INSTANCE.d(TAG, "gyro vector angle with target: " + Math.toDegrees(angle) + " degrees");*/
                    if (angle <= targetAngle) {
                        Logger.INSTANCE.d(TAG, "    ### achieved target angle: " + Math.toDegrees(angle) + " degrees");
                        targetAchieved = true;
                        if (targetCallback != null) {
                            //targetCallback.onAchieved(indx);
                            if (has_lastTargetAngle) {
                                Logger.INSTANCE.d(TAG, "        last target angle: " + Math.toDegrees(lastTargetAngle) + " degrees");
            ...
            /*if( MyDebug.LOG )
                Logger.INSTANCE.d(TAG, "targetAchieved? " + targetAchieved);*/
            }
    ...
    public void testForceTargetAchieved(int indx) {
        Logger.INSTANCE.d(TAG, "testForceTargetAchieved: " + indx);
        if (targetCallback != null) {
            targetCallback.onAchieved(indx);
        }
    }
